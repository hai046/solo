...
(function (z, m) {
    ...
    function u(a, b) {
        var b = b === m ? "," : b, c = {}, d = W(a) ? a : a.split(b), e;
        k(d, function (a, b) {
    ...
    function Y(a, b, c) {
        if (b.indexOf(",") >= 0) k(b.split(","), function () {
            ...
            v[d] === m && (v[d] = {});
            var e = v[d][b];
            e && e.length > 0 ? ta(a, b, e[0]) : (v[d][b] = [], v[d].el = a);
            e = v[d][b];
    ...
    function ea(a, b, c) {
        if (b && b.indexOf(",") >= 0) k(b.split(","), function () {
            ...
            if (d)if (b === m) d in v && (k(v[d],
                function (b, c) {
                    b != "el" && c.length > 0 && ta(a, b, c[0])
                }), delete v[d], gb(a)); else if (v[d]) {
                var e = v[d][b];
                if (e && e.length > 0) {
                    c === m ? (ta(a, b, e[0]), delete v[d][b]) : (k(e, function (a, b) {
                        a > 0 && b === c && e.splice(a, 1)
                    }), e.length == 1 && (ta(a, b, e[0]), delete v[d][b]));
                    var g = 0;
                    k(v[d], function () {
                        g++
                    });
    ...
    function R(a, b, c, d, e) {
        ...
        var f = [],
            a = a.replace(/([ \t\n\r]*)<(\/)?([\w\-:]+)((?:\s+|(?:\s+[\w\-:]+)|(?:\s+[\w\-:]+=[^\s"'<>]+)|(?:\s+[\w\-:"]+="[^"]*")|(?:\s+[\w\-:"]+='[^']*'))*)(\/)?>([ \t\n\r]*)/g, function (a,
                                                                                                                                                                                              l, p, t, va, E, G) {
                var l = l || "", p = p || "", m = t.toLowerCase(), n = va || "", t = E ? " " + E : "", G = G || "";
                if (b && !h[m])return "";
                t === "" && jb[m] && (t = " /");
                kb[m] && (l && (l = " "), G && (G = " "));
                Ia[m] && (p ? G = "\n" : l = "\n");
                ...
                if (lb[m] && !Ia[m])if (d) {
                    ...
                    G = l = "\n";
                    va = 0;
                    for (E = p ? f.length : f.length - 1; va < E; va++)l += e, p || (G += e);
                    t ? f.pop() : p || (G += e)
                } else l = G = "";
                if (n !== "") {
                    var w = J(a);
    ...
    function za(a, b) {
        ...
        function f(a, b) {
            ...
            if (i = /#((?:[\w\-]|\\.)+)$/.exec(a)) c = e(i[1], j, b); else if (i = /\.((?:[\w\-]|\\.)+)$/.exec(a)) c = g(i[1], j, b); else if (i = /\[((?:[\w\-]|\\.)+)\]/.exec(a)) c =
                ...
                if (c === "id") j = e(i, j, b); else if (c === "class") j = g(i, j, b); else if (c === "name") {
                    ...
                    for (var l, p = 0, t = i.length; p < t; p++)l = i[p], d(j, l.nodeName) && xa(b, l) && l.getAttributeNode("name") && c.push(l);
                    j = c
                } else j = h(c, i, j, b);
                c = j
            } else {
        ...
        var t = !1, m, E, n, o, q, w, wa, H, r, s;
        w = 0;
        for (lenth = j.length; w < lenth; w++)if (m = j[w], m === ">") t = !0; else {
            if (w > 0) {
                E = [];
                wa = 0;
                for (r = p.length; wa < r; wa++) {
                    o = p[wa];
                    n = f(m, o);
                    H = 0;
    ...
    function Na(a, b, c) {
        ...
        function g(e,
            ...
            for (var n = e.firstChild, o; n;) {
                ...
                l = o.compareBoundaryPoints(ga, a);
                l >= 0 && p <= 0 && (p = o.compareBoundaryPoints(ha, a));
                p >= 0 && t <= 0 && (t = o.compareBoundaryPoints($, a));
                t >= 0 && m <= 0 && (m = o.compareBoundaryPoints(ia, a));
                if (m >= 0)return !1;
                o = n.nextSibling;
                if (l > 0)if (n.nodeType == 1)if (p >= 0 && t <= 0) b && k.appendChild(n.cloneNode(!0)), c && f.push(n); else {
                    var E;
        ...
        var h = a.doc, f = [], j = a.cloneRange().down(), l = -1, p = -1, t = -1, m = -1, k = a.commonAncestor(),
            n = h.createDocumentFragment();
    ...
    function xb(a, b, c) {
        ...
        if (a.type ===
            ...
            for (var c = b[c].split(","), b = !1, d = 0, e = c.length; d < e; d++) {
                ...
                var h = /^(\.?)([^=]+)(?:=([^=]*))?$/.exec(g), g = h[2];
                h[1] ? (g = da(g), a[0].style[g] && (a[0].style[g] = "")) : a.removeAttr(g)
            }
            b && a.remove(!0)
        }
    }
    ...
    function Ta(a) {
        ...
        d.mousedown(function (a) {
            ...
            a.stopPropagation();
            var p = d.get(), k = s(b.css("left")), n = s(b.css("top")), m = b.width(), o = b.height(), q = a.pageX,
                r = a.pageY;
            e && e();
    ...
    function Yb(a, b, c, d) {
        var e = [Wa === "" ? "<html>" : '<html dir="' + Wa + '">', '<head><meta charset="utf-8" /><title></title>', "<style>", "html {margin:0;padding:0;}", "body {margin:0;padding:5px;}", 'body, td {font:12px/1.5 "sans serif",tahoma,verdana,helvetica;}', "body, p, div {word-wrap: break-word;}", "p {margin:5px 0;}", "table {border-collapse:collapse;}", "img {border:0;}", "noscript {display:none;}", "table.ke-zeroborder td {border:1px dotted #AAA;}", "img.ke-flash {", "\tborder:1px solid #AAA;",
            ...
            "\twidth:100px;", "\theight:100px;", "}", "img.ke-anchor {", "\tborder:1px dashed #666;", "\twidth:16px;", "\theight:16px;", "}", ".ke-script, .ke-noscript {", "\tdisplay:none;", "\tfont-size:0;", "\twidth:0;", "\theight:0;", "}", ".ke-pagebreak {", "\tborder:1px dotted #AAA;", "\tfont-size:0;", "\theight:2px;", "}", "</style>"];
        W(c) || (c = [c]);
        k(c, function (a, b) {
    ...
    function Za(a, b) {
        var c = document.getElementsByTagName("head")[0] ||
            (N ? document.body : document.documentElement), d = document.createElement("script");
        c.appendChild(d);
        d.src = a;
        d.charset = "utf-8";
    ...
    function $a(a) {
        for (var b = document.getElementsByTagName("head")[0] || (N ? document.body : document.documentElement), c = document.createElement("link"), d = Eb(ua(a, "absolute")), e =
            f('link[rel="stylesheet"]', b), g = 0, h = e.length; g < h; g++)if (Eb(ua(e[g].href, "absolute")) === d)return;
        b.appendChild(c);
        c.href = a;
        c.rel = "stylesheet"
    }
            ...
            if (a.useContextmenu) {
                if (a._contextmenus.length !== 0) {
                    ...
                    for (k(a._contextmenus, function () {
                        if (this.title == "-") d.push(this); else if (this.cond && this.cond() && (d.push(this),
        ...
        if (!(o && d !== "br") && (!ca || !(B < 3 && d !== "p")) && !(Ma && B < 9)) {
            ...
            f(c).keydown(function (f) {
                if (!(f.which != 13 || f.shiftKey || f.ctrlKey || f.altKey)) {
                    ...
                    var i = a(b.cmd.range);
                    i == "marquee" || i == "select" ||
                    (d === "br" && !e[i] ? (f.preventDefault(), b.insertHtml("<br />" + (o && B < 9 ? "" : "\u200b"))) : g[i] || O(c, "formatblock", "<p>"))
                }
            });
            f(c).keyup(function (e) {
                if (!(e.which != 13 || e.shiftKey || e.ctrlKey || e.altKey) && d != "br" && !ca)if (b.cmd.selection(), e = a(b.cmd.range), !(e == "marquee" || e == "select"))if (g[e] || O(c, "formatblock", "<p>"), e = b.cmd.commonAncestor("div")) {
    ...
    function Jb(a, b) {
        ...
        Ib(b, g);
        var h = a.pop();
        V(g.html) === V(h.html) && a.length > 0 && (h = a.pop());
        c.designMode ? (c.html(h.html), h.start && (e.moveToBookmark(h),
            this.select())) : f(d).html(V(h.html));
        return this
    }

    function qa(a) {
        function b(a, b) {
            qa.prototype[a] === m && (c[a] = b);
            c.options[a] = b
        }
    ...
    function Kb(a, b) {
        ...
        if ((d = f(a)) && d.length !== 0) {
            ...
            Za(e.langPath + e.langType + ".js?ver=" + encodeURIComponent(f.DEBUG ? Ca : Da), function () {
                c(e)
            });
            return e
        }
    ...
    if (!z.KindEditor) {
        ...
        var Da = "4.1.2 (2012-07-21)", q = navigator.userAgent.toLowerCase(),
            o = q.indexOf("msie") > -1 && q.indexOf("opera") == -1,
            ca = q.indexOf("gecko") > -1 && q.indexOf("khtml") == -1, ba = q.indexOf("applewebkit") > -1,
            Ma = q.indexOf("opera") > -1, cc = q.indexOf("mobile") > -1, dc = /ipad|iphone|ipod/.test(q),
            N = document.compatMode != "CSS1Compat", B = (q = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/.exec(q)) ?
                q[1] : "0", Ca = (new Date).getTime(), P = Math.round, f = {
                DEBUG: !1,
                VERSION: Da,
                IE: o,
                GECKO: ca,
            ...
            kb = u("a,abbr,acronym,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,img,input,ins,kbd,label,map,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var"),
            lb = u("address,applet,blockquote,body,center,dd,dir,div,dl,dt,fieldset,form,frameset,h1,h2,h3,h4,h5,h6,head,hr,html,iframe,ins,isindex,li,map,menu,meta,noframes,noscript,object,ol,p,pre,script,style,table,tbody,td,tfoot,th,thead,title,tr,ul"),
            jb = u("area,base,basefont,br,col,frame,hr,img,input,isindex,link,meta,param,embed"),
            Mb = u("b,basefont,big,del,em,font,i,s,small,span,strike,strong,sub,sup,u"),
            ec = u("img,table,input,textarea,button"), Ia = u("pre,style,script"),
        ...
        f.options = {
            ...
            fontSizeTable: ["15px", "18px", "21px", "20px", "21px", "24px", "20px", "39px"],
            htmlTags: {
                font: ["color", "size", "face", ".background-color"],
                span: [".color", ".background-color", ".font-size", ".font-family", ".background", ".font-weight", ".font-style",
                ...
                table: ["border", "cellspacing", "cellpadding", "width", "height", "align", "bordercolor", ".padding", ".margin", ".border", "bgcolor", ".text-align", ".color", ".background-color", ".font-size", ".font-family", ".font-weight", ".font-style", ".text-decoration",
        ...
        F(C, {
            init: function (a) {
                for (var a = W(a) ? a : [a], b = 0, c = 0, d = a.length; c < d; c++)a[c] && (this[c] = a[c].constructor === C ? a[c][0] : a[c],
                    b++);
                this.length = b;
                this.doc = S(this[0]);
                this.name = La(this[0]);
                ...
                if (b === m)return b = c.length < 1 ? null : ya(c[0], a), b === null ? "" : b;
                c.each(function () {
                    Ka(this, a, b)
                });
                return c
                ...
                if (this.length < 1)return !1;
                return ra(a, this[0].className, " ")
            }, addClass: function (a) {
                this.each(function () {
                    if (!ra(a, this.className, " ")) this.className = A(this.className + " " + a)
                });
                return this
            }, removeClass: function (a) {
                this.each(function () {
                    if (ra(a, this.className, " ")) this.className = A(this.className.replace(RegExp("(^|\\s)" + a + "(\\s|$)"), " "))
                });
                return this
            }, html: function (a) {
                if (a === m) {
        ...
        F(K, {
            init: function (a) {
                ...
                if (o) {
                    ...
                    if (c !== 0)return c;
                    var g, h, i, j;
                    if (a === ha || a === ia) g = this.startContainer, i = this.startOffset;
                    if (a === ga || a === $) g = this.endContainer, i = this.endOffset;
                    if (a === ha || a === ga) h = b.startContainer, j = b.startOffset;
                    if (a === $ || a === ia) h = b.endContainer, j = b.endOffset;
        ...
        F(ka, {
            init: function (a) {
                ...
                var a = n(a, !0), b = this.sel, c = this.range.cloneRange().shrink(), d = c.startContainer,
                    e = c.startOffset, g = S(d), h = this.win, i, j = !1;
                ...
                } else j && c.collapse(!1), i = c.get(!0), b.removeAllRanges(), b.addRange(i);
                h.focus();
                return this
            }, wrap: function (a) {
                var b = this.range, c;
                ...
                f(a).scan(function (a) {
                    if (!g &&
                        ...
                        if (!d && b.type == 3 && A(a.nodeValue).length > 0) {
                            ...
                            l = c;
                            l = l.clone(!0);
                            if (b.type == 3) Sa(l).append(b.clone(!1)), b.replaceWith(l); else {
                                for (var a = b, p; (p = b.first()) && p.children().length == 1;)b = p;
                                p = b.first();
                                for (b = b.doc.createDocumentFragment(); p;)b.appendChild(p[0]), p = p.next();
                                p = a.clone(!0);
                                d = Sa(p);
                                for (var k = p, n = !1; l;) {
            ...
            remove: function (a) {
                ...
                if (d > 0) {
                    ...
                    p && aa(p) && (p.remove(), c.setStart(b, d - 1), b == e && c.setEnd(e, l - 1));
                ...
                function b(b) {
                    ...
                    for (; c && (c = c.lastChild);)if (Qa(f(c), a))return f(c);
                    return null
                }
            ...
            commonAncestor: function (a) {
                ...
                if (a === "forecolor")return (a = this.commonNode({"*": ".color"})) && (c = a.css("color")), c = sa(c), c === "" && (c = "default"), c.toLowerCase();
                if (a === "hilitecolor")return (a =
                    this.commonNode({"*": ".background-color"})) && (c = a.css("background-color")), c = sa(c), c === "" && (c = "default"), c.toLowerCase();
                return c
            }, toggle: function (a, b) {
        ...
        F(Q, {
            init: function (a) {
                ...
                var c = s(a) || 0, d = s(b) || 0, e = Z();
                if (this._alignEl) {
                    var g = f(this._alignEl), h = g.pos(), c = P(g[0].clientWidth / 2 - c / 2),
        ...
        F(ma, Q, {
            init: function (a) {
                function b() {
                    ...
                    c.cmd = j;
                    c.html(la(c.srcElement));
                    o ? (b.body.disabled = !0, b.body.contentEditable =
                        !0, b.body.removeAttribute("disabled")) : b.designMode = "on";
                    a.afterCreate && a.afterCreate.call(c)
                }

                var c = this;
                ma.parent.init.call(c, a);
                ...
                var d = n(a.themesPath, ""), e = a.bodyClass, g = a.cssPath, h = a.cssData,
                    i = location.host.replace(/:\d+/, "") !== document.domain,
                    j = "document.open();" + (i ? 'document.domain="' + document.domain + '";' : "") + "document.close();",
                ...
                f(a).unbind();
                f(this.win).unbind();
                la(this.srcElement, this.html());
                this.srcElement.show();
                a.write("");
                this.iframe.unbind();
                this.textarea.unbind();
                ma.parent.remove.call(this)
            }, html: function (a, b) {
                var c = this.doc;
                if (this.designMode) {
                    c = c.body;
                    if (a === m)return a = b ? "<!doctype html><html>" + c.parentNode.innerHTML + "</html>" : c.innerHTML, this.beforeGetHtml && (a = this.beforeGetHtml(a)), ca && a == "<br />" && (a = ""), a;
        ...
        F(Aa, Q, {
            init: function (a) {
                ...
                return this._itemMap[a] =
                    f("span.ke-icon-" + a, this.div).parent()
            }, select: function (a) {
            ...
            init: function (a) {
                ...
                if (a.title === "-") this.div.append(f('<div class="ke-menu-separator"></div>')); else {
                    var b = f('<div class="ke-menu-item" unselectable="on"></div>'),
                        ...
                        d = f('<div class="ke-inline-block ke-menu-item-right"></div>'), e = r(a.height),
                        g = n(a.iconClass, "");
                    this.div.append(b);
                    e && (b.css("height", e), d.css("line-height", e));
                    var h;
                    this.centerLineMode && (h = f('<div class="ke-inline-block ke-menu-item-center"></div>'),
                    e && h.css("height", e));
        ...
        F(oa, Q, {
            init: function (a) {
                ...
                for (var e = 0; e < b.length; e++)for (var c = a.insertRow(e + 1), f = 0; f < b[e].length; f++)d = c.insertCell(f), this._addAttr(d, b[e][f],
                    "ke-colorpicker-cell")
                ...
                b ? a.append(f('<div class="ke-colorpicker-cell-color" unselectable="on"></div>').css("background-color", b)) :
        ...
        f.ColorPickerClass = oa;
        f.colorpicker = Cb;
        F(Ya, {
            init: function (a) {
                var b = f(a.button), c = a.fieldName || "file", d = a.url || "", e = b.val(), g = a.extraParams || {},
                    h = b[0].className || "", i = a.target || "kindeditor_upload_iframe_" + (new Date).getTime();
                a.afterError = a.afterError || function (a) {
                        alert(a)
                    };
                var j = [], l;
                for (l in g)j.push('<input type="hidden" name="' +
                    l + '" value="' + g[l] + '" />');
                c = ['<div class="ke-inline-block ' + h + '">', a.target ? "" : '<iframe name="' + i + '" style="display:none;"></iframe>', a.form ? '<div class="ke-upload-area">' : '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + i + '" action="' + d + '">', '<span class="ke-button-common">', j.join(""), '<input type="button" class="ke-button-common ke-button" value="' + e + '" />', "</span>", '<input type="file" class="ke-upload-file" name="' + c + '" tabindex="-1" />', a.form ? "</div>" :
                    "</form>", "</div>"].join("");
                c = f(c, b.doc);
                b.hide();
                b.before(c);
                ...
                b.bind("load", function () {
                    ...
                    c.reset();
                    f(c).remove(!0);
                    var c = f.iframeDoc(b), d = c.getElementsByTagName("pre")[0],
                        e = "", g, e = d ? d.innerHTML : c.body.innerHTML;
        ...
        F(pa, Q, {
            init: function (a) {
                ...
                (e || g || h) && l.append(m);
                k([{btn: e, name: "preview"}, {btn: g, name: "yes"}, {btn: h, name: "no"}], function () {
                    if (this.btn) {
                        var a = this.btn, a = a || {}, b = a.name || "",
                            c = f('<span class="ke-button-common ke-button-outer" title="' +
                                b + '"></span>'),
        ...
        f.tabs = function (a) {
            ...
            b.select = function (a) {
                ...
                k(e, function (c, d) {
                    d.unbind();
                    c === a ?
                        (d.addClass("ke-tabs-li-selected"), f(d.data("tab").panel).show("")) : (d.removeClass("ke-tabs-li-selected").removeClass("ke-tabs-li-on").mouseover(function () {
        ...
        f.ajax = function (a, b, c, d, e) {
            ...
            if (c == "POST") {
                var h = [];
                k(d, function (a, b) {
                    h.push(encodeURIComponent(a) + "=" + encodeURIComponent(b))
                });
                try {
        ...
        qa.prototype = {
            ...
            loadPlugin: function (a, b) {
                ...
                c.isLoading = !0;
                Za(c.pluginsPath + a + "/" + a + ".js?ver=" + encodeURIComponent(f.DEBUG ? Ca : Da), function () {
                    c.isLoading = !1;
                ...
                function a() {
                    l.height() === 0 ? setTimeout(a, 100) : c.resize(e, g)
                }
                ...
                if (d) {
                    ...
                    height: "",
                    overflow: ""
                }), f(document.body.parentNode).css("overflow", "")), c._scrollPos && z.scrollTo(c._scrollPos.x, c._scrollPos.y);
                var k = [];
                f.each(c.items, function (a, b) {
                    b == "|" ? k.push('<span class="ke-inline-block ke-separator"></span>') : b == "/" ? k.push('<div class="ke-hr"></div>') : (k.push('<span class="ke-outline" data-name="' +
                        b + '" title="' + c.lang(b) + '" unselectable="on">'), k.push('<span class="ke-toolbar-icon ke-toolbar-icon-url ke-icon-' + b + '" unselectable="on"></span></span>'))
                });
                var i = c.toolbar = Bb({
                    src: i,
                    html: k.join(""),
                ...
                }), i.select("fullscreen"), l.first().css("visibility", "hidden"), l.last().css("visibility", "hidden")) : (ca && f(z).bind("scroll", function () {
                    c._scrollPos = Z()
                }), c.resizeType > 0 ? Ta({
                    moveEl: h, clickEl: l, moveFn: function (a, c, d, e, f, g) {
                        e += g;
                        b(null, e)
                    }
                ...
                b !== null && (b = s(b) - this.toolbar.div.height() -
                    this.statusbar.height(), b > 0 && s(b) > this.minHeight && this.edit.setHeight(b));
                return this
            }, select: function () {
                this.isCreated && this.cmd.select();
                return this
            }, html: function (a) {
                if (a === m)return this.isCreated ? this.edit.html() : la(this.srcElement);
                this.isCreated ? this.edit.html(a) : la(this.srcElement, a);
                return this
            }, fullHtml: function () {
                return this.isCreated ? this.edit.html(m, !0) : ""
            }, text: function (a) {
                return a === m ? A(this.html().replace(/<(?!img|embed).*?>/ig, "").replace(/&nbsp;/ig, " ")) : this.html(D(a))
            }, isEmpty: function () {
                ...
                var a = a.toLowerCase(), b = this.cmd, c = M(a, "selectall,copy,paste,print".split(",")) <
                    0;
            ...
            focus: function () {
                ...
                b.designMode && !this._firstAddBookmark ? (b = this.cmd.range, a = b.createBookmark(!0), a.html = ab(c.innerHTML), b.moveToBookmark(a)) :
                    a = {html: d};
                ...
                o ? d.body.contentEditable =
                    !a : d.designMode = a ? "off" : "on";
                ...
                if (b.dialogs.length > 0) {
                    var c = b.dialogs[b.dialogs.length -
                    1];
        ...
        o && B < 7 && O(document, "BackgroundImageCache", !0);
        f.EditorClass = qa;
        f.editor = function (a) {
            return new qa(a)
        };
        ...
        Fb("core", function (a) {
            var b = this, c = {
                ...
                underline: "U", print: "P", selectall: "A"
            };
            ...
            b.clickToolbar("formatblock", function () {
                ...
                k(a, function (a, e) {
                    ...
                    a.charAt(0) === "h" && (k +=
                        "font-weight:bold;");
                    f.addItem({
                        title: '<span style="' + k + '" unselectable="on">' + e + "</span>",
                        height: c[a] + 12,
                        checked: d === a || d === e,
                        click: function () {
            ...
            k("prop,cellprop,colinsertleft,colinsertright,rowinsertabove,rowinsertbelow,rowmerge,colmerge,rowsplit,colsplit,coldelete,rowdelete,insert,delete".split(","), function (a, c) {
            ...
            b.afterCreate(function () {
                ...
                a(d.body).bind("paste", function (n) {
                    if (b.pasteType === 0) n.stop(); else if (!m) {
                        m = !0;
                        a("div." + k, d).remove();
                        f = b.cmd.selection();
            ...
            b.beforeSetHtml(function (a) {
                ...
                }).replace(/(<[^>]*)(href|src)="([^"]*)"([^>]*>)/ig, function (a,
                                                                               b, c, d, e) {
