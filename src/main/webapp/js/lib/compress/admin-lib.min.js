!function (e, t) {
    ...
    var F = e.document, M = e.navigator, _ = e.location, H = function () {
        ...
        var r, i, o, a, s = function (e, t) {
            ...
            }, l = e.jQuery, u = e.$, c = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, f = /\S/, d = /^\s+/, p = /\s+$/,
            h = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, m = /^[\],:{}\s]*$/, g = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,
            y = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, v = /(?:^|:|,)(?:\s*\[)+/g,
            b = /(webkit)[ \/]([\w.]+)/, x = /(opera)(?:.*version)?[ \/]([\w.]+)/, T = /(msie) ([\w.]+)/,
            w = /(mozilla)(?:.*? rv:([\w.]+))?/, N = /-([a-z]|[0-9])/gi, C = /^-ms-/, E = function (e, t) {
                return (t + "").toUpperCase()
            }, k = M.userAgent, S = Object.prototype.toString, A = Object.prototype.hasOwnProperty,
            L = Array.prototype.push, D = Array.prototype.slice, j = String.prototype.trim, _ = Array.prototype.indexOf,
            H = {};
    ...
    H.extend({
        Deferred: function (e) {
            var t, n = H.Callbacks("once memory"), r = H.Callbacks("once memory"), i = H.Callbacks("memory"),
            ...
            var r = B.call(arguments, 0), i = 0, o = r.length, a = Array(o), s = o,
                l = o <= 1 && e && H.isFunction(e.promise) ? e : H.Deferred(), u = l.promise();
            if (o > 1) {
    ...
    H.extend({
        ...
        data: function (e, n, r, i) {
            if (H.acceptData(e)) {
                var o, a, s, l = H.expando, u = "string" == typeof n, c = e.nodeType, f = c ? H.cache : e,
    ...
    var W, I, $, R = /[\n\t\r]/g, X = /\s+/, z = /\r/g, V = /^(?:button|input)$/i,
        U = /^(?:button|input|object|select|textarea)$/i, G = /^a(?:rea)?$/i,
    ...
    var Q = /^(?:textarea|input|select)$/i, K = /^([^\.]*)?(?:\.(.+))?$/, Z = /(?:^|\s)hover(\.\S+)?\b/, ee = /^key/,
        te = /^(?:mouse|contextmenu)|click/, ne = /^(?:focusinfocus|focusoutblur)$/,
        re = /^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/, ie = function (e) {
            var t = re.exec(e);
    ...
    H.event = {
        ...
        dispatch: function (n) {
            ...
            var r, i, o, a, s, l, u, c, f, d, p = (H._data(this, "events") || {})[n.type] || [], h = p.delegateCount,
                m = [].slice.call(arguments, 0), g = !n.exclusive && !n.namespace, y = H.event.special[n.type] || {},
                v = [];
    ...
    var se = /Until$/, le = /^(?:parents|prevUntil|prevAll)/, ue = /,/, ce = /^.[^:#\[\.,]*$/,
        fe = Array.prototype.slice, de = H.expr.match.globalPOS, pe = {children: !0, contents: !0, next: !0, prev: !0};
    H.fn.extend({
        find: function (e) {
            var t, n, r = this;
    ...
    var he = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        me = / jQuery\d+="(?:\d+|null)"/g, ge = /^\s+/,
        ye = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, ve = /<([\w:]+)/,
        be = /<tbody/i, xe = /<|&#?\w+;/, Te = /<(?:script|style)/i, we = /<(?:script|object|embed|option|style)/i,
        Ne = new RegExp("<(?:" + he + ")[\\s/>]", "i"), Ce = /checked\s*(?:[^=]|=\s*.checked.)/i,
        Ee = /\/(java|ecma)script/i, ke = /^\s*<!(?:\[CDATA\[|\-\-)/, Se = {
    ...
    Se.optgroup = Se.option, Se.tbody = Se.tfoot = Se.colgroup = Se.caption = Se.thead, Se.th = Se.td, H.support.htmlSerialize || (Se._default = [1, "div<div>", "</div>"]), H.fn.extend({
        ...
        clone: function (e, t, n) {
            var r, i, o,
                a = H.support.html5Clone || H.isXMLDoc(e) || !Ne.test("<" + e.nodeName + ">") ? e.cloneNode(!0) : g(e);
            ...
            for (var l, u = 0; null != (l = e[u]); u++)if ("number" == typeof l && (l += ""), l) {
                if ("string" == typeof l)if (xe.test(l)) {
                    l = l.replace(ye, "<$1></$2>");
                    var c, f = (ve.exec(l) || ["", ""])[1].toLowerCase(), d = Se[f] || Se._default, p = d[0],
                        h = t.createElement("div"), m = Ae.childNodes;
    ...
    var Le, De, je, Fe = /alpha\([^)]*\)/i, Me = /opacity=([^)]*)/, _e = /([A-Z]|^ms)/g, He = /^[\-+]?(?:\d*\.)?\d+$/i,
        Oe = /^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i, Be = /^([\-+])=([\-+.\de]+)/, Pe = /^margin/,
        qe = {position: "absolute", visibility: "hidden", display: "block"}, We = ["Top", "Right", "Bottom", "Left"];
    ...
    var Ie, $e, Re = /%20/g, Xe = /\[\]$/, ze = /\r?\n/g, Ve = /#.*$/, Ue = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        ...
        Ye = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, Je = /^(?:GET|HEAD)$/, Qe = /^\/\//,
        Ke = /\?/, Ze = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, et = /^(?:select|textarea)/i, tt = /\s+/,
        nt = /([?&])_=[^&]*/, rt = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, it = H.fn.load, ot = {}, at = {},
        st = ["*/"] + ["*"];
    try {
        Ie = _.href
    } catch (e) {
    ...
    $e = rt.exec(Ie.toLowerCase()) || [], H.fn.extend({
        ...
        ajax: function (e, n) {
            ...
            var i, o, a, s, l, f, d, h, m = H.ajaxSetup({}, n), g = m.context || m,
                y = g !== m && (g.nodeType || g instanceof H) ? H(g) : H.event, v = H.Deferred(),
                b = H.Callbacks("once memory"), x = m.statusCode || {}, T = {}, w = {}, N = 0, C = {
    ...
    H.ajaxSetup({
        ...
        if ("jsonp" === t.dataTypes[0] || t.jsonp !== !1 && (ut.test(t.url) || i && ut.test(t.data))) {
            var o, a = t.jsonpCallback = H.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s = e[a],
                l = t.url, u = t.data, c = "$1" + a + "$2";
    ...
    var pt, ht, mt, gt, yt = {}, vt = /^(?:toggle|show|hide)$/, bt = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,
        xt = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]];
    H.fn.extend({
        show: function (e, t, n) {
            var o, a;
            ...
            function o() {
                ...
                var t, n, i, o, s, l, u, c, f, d, p, h = H.extend({}, a), m = 1 === this.nodeType,
    ...
    Tt = "getBoundingClientRect" in F.documentElement ? function (e, t, r, i) {
        ...
        var o = t.body, a = n(t), s = r.clientTop || o.clientTop || 0, l = r.clientLeft || o.clientLeft || 0,
            u = a.pageYOffset || H.support.boxModel && r.scrollTop || o.scrollTop,
            c = a.pageXOffset || H.support.boxModel && r.scrollLeft || o.scrollLeft, f = i.top + u - s,
            d = i.left + c - l;
        return {top: f, left: d}
    } : function (e, t, n) {
        ...
        bodyOffset: function (e) {
            ...
            var i, o, a = H(e), s = a.offset(), l = H.css(e, "top"), u = H.css(e, "left"),
                c = ("absolute" === r || "fixed" === r) && H.inArray("auto", [l, u]) > -1, f = {}, d = {};
        ...
        position: function () {
            ...
            var e = this[0], t = this.offsetParent(), n = this.offset(),
                r = Nt.test(t[0].nodeName) ? {top: 0, left: 0} : t.offset();
...
!function (t) {
    ...
    t.cleanData = function (e) {
        ...
        for (var n, s, o = i.call(arguments, 1), r = 0, a = o.length; r < a; r++)for (n in o[r])s = o[r][n], o[r].hasOwnProperty(n) && void 0 !== s && (t.isPlainObject(s) ? e[n] = t.isPlainObject(e[n]) ? t.widget.extend({}, e[n], s) : t.widget.extend({}, s) : e[n] = s);
        return e
...
!function (e) {
    ...
    e.ajaxTransport("iframe", function (r) {
        if (r.async) {
            var n, a, o, i = r.initialIframeSrc || "javascript:false;";
            return {
                send: function (p, m) {
                    n = e('<form style="display:none;"></form>'), n.attr("accept-charset", r.formAcceptCharset), o = /\?/.test(r.url) ? "&" : "?", "DELETE" === r.type ? (r.url = r.url + o + "_method=DELETE", r.type = "POST") : "PUT" === r.type ? (r.url = r.url + o + "_method=PUT", r.type = "POST") : "PATCH" === r.type && (r.url = r.url + o + "_method=PATCH", r.type = "POST"), t += 1, a = e('<iframe src="' + i + '" name="iframe-transport-' + t + '"></iframe>').bind("load", function () {
                        var t, o = e.isArray(r.paramName) ? r.paramName : [r.paramName];
                        a.unbind("load").bind("load", function () {
                            ...
                            m(200, "success", {iframe: t}), e('<iframe src="' + i + '"></iframe>').appendTo(n), window.setTimeout(function () {
                                n.remove()
                            }, 0)
                        }), n.prop("target", a.prop("name")).prop("action", r.url).prop("method", r.type), r.formData && e.each(r.formData, function (t, r) {
                            e('<input type="hidden"/>').prop("name", r.name).val(r.value).appendTo(n)
                        }), r.fileInput && r.fileInput.length && "POST" === r.type && (t = r.fileInput.clone(), r.fileInput.after(function (e) {
                            return t[e]
                        }), r.paramName && r.fileInput.each(function (t) {
                            e(this).prop("name", o[t] || r.paramName)
                        }), n.append(r.fileInput).prop("enctype", "multipart/form-data").prop("encoding", "multipart/form-data"), r.fileInput.removeAttr("form")), n.submit(), t && t.length && r.fileInput.each(function (r, n) {
                            var a = e(t[r]);
                            e(n).prop("name", a.prop("name")).attr("form", a.attr("form")), a.replaceWith(n)
                        })
                    }), n.append(a).appendTo(document.body)
                }, abort: function () {
                    a && a.unbind("load").prop("src", i), n && n.remove()
                }
            }
        }
    }), e.ajaxSetup({
...
!function (e) {
    ...
    function t(t) {
        ...
        return function (r) {
            ...
            n && e.inArray("Files", n.types) !== -1 && this._trigger(t, e.Event(t, {delegatedEvent: r})) !== !1 && (r.preventDefault(), i && (n.dropEffect = "copy"))
        }
    }
    ...
    e.support.fileInput = !(new RegExp("(Android (1\\.[0156]|2\\.[01]))|(Windows Phone (OS 7|8\\.0))|(XBLWP)|(ZuneWP)|(WPDesktop)|(w(eb)?OSBrowser)|(webOS)|(Kindle/(1\\.0|2\\.[05]|3\\.0))").test(window.navigator.userAgent) || e('<input type="file">').prop("disabled")), e.support.xhrFileUpload = !(!window.ProgressEvent || !window.FileReader), e.support.xhrFormDataFileUpload = !!window.FormData, e.support.blobSlice = window.Blob && (Blob.prototype.slice || Blob.prototype.webkitSlice || Blob.prototype.mozSlice), e.widget("blueimp.fileupload", {
        ...
        _initXHRData: function (t) {
            var i, r = this, n = t.files[0], o = t.multipart || !e.support.xhrFileUpload,
        ...
        _chunkedUpload: function (t, i) {
            ...
            var r, n, o = this, s = t.files[0], a = s.size, l = t.uploadedBytes, p = t.maxChunkSize || a,
                u = this._blobSlice, d = e.Deferred(), h = d.promise();
            return !(!(this._isXHRUpload(t) && u && (l || p < a)) || t.data) && (!!i || (l >= a ? (s.error = t.i18n("uploadedBytes"), this._getXHRPromise(!1, t.context, [null, "error", s.error])) : (n = function () {
                    ...
                    i.blob = u.call(s, l, l + p, s.type), i.chunkSize = i.blob.size, i.contentRange = "bytes " + l + "-" + (l + i.chunkSize - 1) + "/" + a, o._initXHRData(i), o._initProgressListener(i), r = (o._trigger("chunksend", null, i) !== !1 && e.ajax(i) || o._getXHRPromise(!1, i.context)).done(function (r, s, p) {
                        ...
                        }), i), t.uploadedBytes = i.uploadedBytes = l, i.result = r, i.textStatus = s, i.jqXHR = p, o._trigger("chunkdone", null, i), o._trigger("chunkalways", null, i), l < a ? n() : d.resolveWith(i.context, [r, s, p])
                    }).fail(function (e, t, r) {
        ...
        _onAdd: function (t, i) {
            var r, n, o, s, a = this, l = !0, p = e.extend({}, this.options, i), u = i.files, d = u.length,
                h = p.limitMultiFileUploads, c = p.limitMultiFileUploadSize, f = p.limitMultiFileUploadSizeOverhead,
                g = 0, _ = this._getParamName(p), m = 0;
            if (!c || d && void 0 !== u[0].size || (c = void 0), (p.singleFileUploads || h || c) && this._isXHRUpload(p))if (p.singleFileUploads || c || !h)if (!p.singleFileUploads && c)for (o = [], r = [], s = 0; s < d; s += 1)g += u[s].size + f, (s + 1 === d || g + u[s + 1].size + f > c || h && s + 1 - m >= h) && (o.push(u.slice(m, s + 1)), n = _.slice(m, s + 1), n.length || (n = _), r.push(n), m = s + 1, g = 0); else r = _; else for (o = [], r = [], s = 0; s < d; s += h)o.push(u.slice(s, s + h)), n = _.slice(s, s + h), n.length || (n = _), r.push(n); else o = [u], r = [_];
...
!function (t) {
    ...
    t.extend(e.prototype, {
        bowknot: {version: "0.0.0.9", author: "lly219@gmail.com"}, getDate: function (t, e) {
            var a = new Date(t), s = a.getFullYear().toString().substr(2, 2), i = a.getMonth() + 1, n = a.getDate(),
                l = a.getHours(), o = a.getSeconds(), d = a.getMinutes();
            switch (e) {
                case void 0:
                    return i + "/" + n + "/" + s;
                case 1:
    ...
    t.fn.extend({paginate: {version: "0.0.0.8", author: "lly219@gmail.com"}});
    var e = (new Date).getTime(), a = "paginate", s = function () {
        this._defaults = {
            styleClass: {
    ...
    t.extend(s.prototype, {
        _attach: function (e, s) {
            e.id || (this.uuid++, e.id = "dp" + this.uuid);
            var i = this._newInst(t(e));
            i.settings = t.extend({errorMessage: "input error!"}, s || {}), t.data(e, a, i), this._init(e)
        }, _newInst: function (t) {
            ...
            var a = this._getInst(e), s = a.id, i = a.settings;
            t("#" + s).html("<div id='" + s + "Paginate' class='" + this._getDefaults(t.paginate._defaults, i, "styleClass").paginateClass + "'></div>"), this._build(e)
        }, _build: function (e) {
            var a = this._getInst(e), s = a.id, i = a.settings, n = this._getDefaults(this._defaults, i, "styleClass"),
                l = i.pageCount, o = i.currentPage,
                d = "<$tagStart class='button paginate-page'>                <span class='button-left'></span>                <span class='button-bg'>" + i.previousPageText + "</span>                <span class='button-right'></span>            </$tagEnd>",
                r = "<$tagStart class='button paginate-page'>                <span class='button-left'></span>                <span class='button-bg'>" + i.nextPageText + "</span>                <span class='button-right'></span>            </$tagEnd>",
                c = "", u = "<span class='" + n.pageCountClass + "'>" + o + "/" + l + "</span>",
                h = "<div class='button'>                <span class='button-left'></span>                <span class='button-bg'>                    <input class='" + n.inputPageClass + "' id='" + s + "PaginateInput'/>                </span>                <span class='button-right'></span>            </div>            <a href='javascript:void(0);' class='button' id='" + s + "PaginateSubmit'>                <span class='button-left'></span>                <span class='button-bg'>" + i.goText + "</span>                <span class='button-right'></span>            </a>";
            switch (d = 1 === o || 0 === o ? d.replace("$tagStart", "div").replace("$tagEnd", "div") : d.replace("$tagStart", "a href='javascript:void(0)'").replace("$tagEnd", "a"), r = o !== l ? r.replace("$tagStart", "a href='javascript:void(0)'").replace("$tagEnd", "a") : r.replace("$tagStart", "div").replace("$tagEnd", "div"), i.type) {
                case"taobao":
                    var p = this._getTaobaoPages(o, l), g = "";
                    h = "";
                    for (var f = 0; f < p.length; f++)g = o === p[f].pageNum ? " pagination-current-page" : "", c += "<span data-page='" + p[f].pageNum + "' class='pagination-pages" + g + "'>" + p[f].text + "</span>";
                    break;
                case"custom":
                    for (var p = i.custom, g = "", f = 0; f < p.length; f++)g = o === p[f] ? " pagination-current-page" : "", c += "<span data-page='" + p[f] + "' class='pagination-pages" + g + "'>" + p[f] + "</span>"
            }
            1 === l ? t("#" + s + "Paginate").html(u) : t("#" + s + "Paginate").html(d + c + r + u + h), this._bindEvent(e)
        }, _getTaobaoPages: function (t, e) {
            var a = [], s = 2, i = 4, n = 3, l = 0, o = 0, d = 0;
            for (t >= i ? (n = t - Math.ceil(i / 2), o = t + Math.ceil(i / 2) + 1, l = o < e ? o : e) : t < i && (o = t + Math.ceil(i / 2) + 1, l = o < e ? o : e), n < 3 && (n = 3), s = n; s <= l; s++)a.push({
                pageNum: s,
                text: s
            });
            for (n > 3 && (d = 2 + (n - 2), a.unshift({
                pageNum: d,
                text: "..."
            })), s = e < 2 ? 0 === t ? 0 : 1 : 2; s >= 1; s -= 1)a.unshift({pageNum: s, text: s});
            return l < e && (d = l + Math.ceil(i / 2), d > e && (d = e), a.push({pageNum: d, text: "..."})), a
        }, _bindEvent: function (e) {
            var a = this._getInst(e), s = a.id;
            t("#" + s + "PaginateInput").bind("keypress", {target: e}, function (e) {
                13 === e.keyCode && t.paginate._goToPageAction(e)
            }), t("#" + s + "Paginate .pagination-pages").bind("click", {target: e, isPage: !0}, function (e) {
                t.paginate._goToPageAction(e)
            }), t("#" + s + "PaginateSubmit").bind("click", {target: e}, this._goToPageAction), t("#" + s + "Paginate a.paginate-page").bind("click", {
                target: e,
                isPage: !0
            }, function (e) {
                t.paginate._goToPageAction(e)
            })
        }, _goToPageAction: function (e) {
            var a = e.data.target, s = t.paginate._getInst(a), i = s.id, n = s.settings,
                l = t("#" + i + "PaginateInput").val();
            if (e.data.isPage) {
                l = n.currentPage;
                var o = t(e.target).closest("a").text();
                t.trim(o) === n.previousPageText ? l-- : t.trim(o) === n.nextPageText ? l++ : l = parseInt(t(e.target).data("page"))
            }
            if (n.currentPage !== l) {
                var d = /^[0-9]*[1-9][0-9]*$/;
                l > 0 && l <= n.pageCount && d.test(l) ? n.bind(l) : (n.bind(l, n.errorMessage), t("#" + i + "PaginateInput").val(""))
            }
        }, _updatePaginate: function (e, a) {
            a && t.extend(this._getInst(e).settings, a), this._build(e)
        }, _getDefaults: function (t, e, a) {
            if ("styleClass" === a) {
                if ("default" === e.theme || void 0 === e.theme)return t.styleClass;
                e.styleClass = {};
                for (var s in t[a])e.styleClass[s] = e.theme + "-" + t.styleClass[s]
            } else {
                if ("height" === a && "auto" !== e[a] || "width" === a)return null === e[a] || void 0 === e[a] ? t[a] + "px" : e[a] + "px";
                if (null === e[a] || void 0 === e[a])return t[a]
            }
            return e[a]
        }, _destroyPaginate: function () {
        }
    }), t.fn.paginate = function (e) {
        var a = Array.prototype.slice.call(arguments);
        return "string" == typeof e ? (a.shift(), t.paginate["_" + e + "Paginate"].apply(t.paginate, [this[0]].concat(a))) : this.each(function () {
            t.paginate._attach(this, e)
        })
    }, t.paginate = new s, window["DP_jQuery_" + e] = t
}(jQuery), function (t) {
    t.fn.extend({table: {version: "0.0.1.0", author: "lly219@gmail.com"}});
    var e = (new Date).getTime(), a = "table", s = function () {
        this._defaults = {
            styleClass: {
    ...
    t.extend(s.prototype, {
        _attach: function (e, s) {
            ...
            var a = this._getInst(e), s = a.settings;
            t(e).html("<div class='" + this._getDefaults(this._defaults, s, "styleClass").mainClass + "' id='" + a.id + "Table'></div>"), this._build(e)
        }, _build: function (e) {
            var a = this._getInst(e), s = a.settings, i = a.id, n = this._getDefaults(this._defaults, s, "styleClass"),
                l = "<div id='" + i + "TableHeader' class='" + n.headerClass + "'></div><div id='" + i + "TableMain' class='" + n.bodyClass + "' style='height:" + (s.height ? s.height + "px" : "auto") + "'></div>";
            t("#" + i + "Table").html(l), this._buildHeader(e), s.data && (this._buildBody(e), this._bindEvent(e))
        }, _buildHeader: function (a) {
            for (var s = this._getInst(a).settings, i = s.colModel, n = this._getInst(a).id, l = "<table cellpadding='0' cellspacing='0' style='width:100%'><tr>", o = 0; o < i.length; o++) {
                var d = n + "_" + i[o].index;
                l += i[o].minWidth ? "<th style='min-width:" + i[o].minWidth + "px;'>" : "<th style='width:" + i[o].width + "px;'>", l += "checkbox" === i[o].type ? i[o].isLabel ? i[o].text : "<input id='" + d + "' onclick=\"DP_jQuery_" + e + ".table._selectHeaderCheckbox(this);\" type='checkbox'/></th>" : "<span id='" + d + "'>" + i[o].text ? i[o].text : "</span></th>"
            }
            t("#" + n + "TableHeader").html(l + "</tr></table>")
        }, _buildBody: function (e) {
            for (var a = this._getInst(e).id, s = this._getInst(e).settings, i = s.data, n = this._getDefaults(this._defaults, s, "styleClass"), l = "", o = 0; o < i.length; o++)"all" !== i[o].groupName && (l += "<div  id='" + a + "SubTitle" + o + "'class='" + n.subTitleClass + "'><div class='left " + n.subTitleShowClass + "'></div><div class='left'>" + i[o].groupName + "</div><div class='clear'></div></div>"), l += "<table id=" + a + "SubTable" + o + " style='width:100%;' cellpadding='0' cellspacing='0'>" + this._buildData(e, i[o].groupData, o) + "</table>";
            t("#" + a + "TableMain").html(l)
        }, _buildData: function (a, s, i) {
            for (var n = this._getInst(a).id, l = this._getInst(a).settings, o = l.colModel, d = this._getDefaults(this._defaults, l, "styleClass"), r = "", c = 0; c < s.length; c++) {
                var u = s[c], h = "<tbody class='$CLASS'>", p = "<tr>", g = d.oddRowClass;
                c % 2 === 1 && (g = d.evenRowClass), l.expendRow && (p = '<tr class="' + d.hasExpendClass + '">'), u.uuuid = l.length++;
                for (var f = 0; f < o.length; f++) {
                    var v = o[f].index, _ = u[v], b = o[f].align ? "text-align:" + o[f].align + ";" : "";
                    if (void 0 !== _ && null !== _ && "" !== t.trim(_) || (_ = "&nbsp;"), 0 === c && (b += o[f].minWidth ? "min-width:" + o[f].minWidth + "px;" : "width:" + o[f].width + "px;"), p += "<td style='" + b + "'>", o[f].type) {
                        var m = "", y = "", C = "", w = n + "_" + v + "_" + i + "_" + c;
                        u[v].value && (y = "checked='checked'", h = h.replace("$CLASS", d.lineSelectedClass + " " + g), l.selectedRows.push(u)), u[v].disabled && (C = "disabled='disabled'"), m = "<input name='" + n + "_" + v + "' id='" + w + "' type='" + o[f].type + "' onclick=\"DP_jQuery_" + e + '.table._selectCheckbox(this);" ' + y + " " + C + "/>", _ = m
                    }
                    o[f].style && (_ = "<div style='" + o[f].style + "'>" + _ + "</div>"), p += _ + "</td>"
                }
                if (r += h.replace("$CLASS", g) + p + "</tr>", l.expendRow) {
                    var x = u[l.expendRow.index];
                    void 0 === x && (x = ""), r += "<tr class='none " + d.expendRowClass + " " + g + "'><td colspan='" + o.length + "'>" + x + "</td></tr>"
                }
                r += "</tbody>"
            }
            return 0 === s.length && (r = "<tbody><tr><td align='center' colspan='" + o.length + "'>" + l.noDataTip + "</td></tr></tbody>"), r
        }, _bindEvent: function (e) {
            for (var a = this._getInst(e), s = a.id, i = a.settings, n = a.settings.colModel, l = this._getDefaults(this._defaults, i, "styleClass"), o = i.data, d = 0; d < o.length; d++) {
                "all" !== o[0].groupName && t("#" + s + "SubTitle" + d).click(function () {
                    var e = t(this).find("div")[0];
                    e.className.indexOf(l.subTitleShowClass) != -1 ? (e.className = e.className.replace(l.subTitleShowClass, l.subTitleHideClass), t(this).next().hide()) : (e.className = e.className.replace(l.subTitleHideClass, l.subTitleShowClass), t(this).next().show())
                }).mouseover(function () {
                    this.className = l.subTitleHoverClass
                }).mouseout(function () {
                    this.className = l.subTitleClass
                });
                for (var r = i.bind ? i.bind : [], c = o[d].groupData, u = 0; u < c.length; u++) {
                    for (var h = t(t("#" + s + "SubTable" + d + " tbody")[u]), p = 0; p < r.length; p++)h.bind(r[p].type, {
                        groupData: c[u],
                        bindNum: p
                    }, function (t) {
                        r[t.data.bindNum].action(t, t.data.groupData)
                    });
                    h.mouseover(function () {
                        t(this).hasClass(l.lineHoverClass) || (t("#" + s + " tbody").each(function () {
                            t(this).removeClass(l.lineHoverClass), 2 === t(this).find("tr").length && (t(this).find("tr")[1].style.display = "none")
                        }), t(this).addClass(l.lineHoverClass), 2 === t(this).find("tr").length && (t.browser.msie ? t.browser.version > 7 && (t(this).find("tr")[1].style.display = "block") : t(this).find("tr")[1].style.display = "table-row"))
                    });
                    for (var g = 0; g < n.length; g++)if (n[g].bind)for (var f = n[g].bind, v = 0; v < f.length; v++)t(h.find("td")[g]).bind(f[v].type, {
                        groupData: c[u],
                        bindNum: v,
                        colNum: g
                    }, function (t) {
                        n[t.data.colNum].bind[t.data.bindNum].action(t, t.data.groupData)
                    })
                }
            }
        }, _selectHeaderCheckbox: function (e) {
            for (var s = e.id.split("_")[0], i = e.id.split("_")[1], n = t("#" + s).data(a).settings, l = n.data, o = this._getDefaults(this._defaults, n, "styleClass"), d = 0; d < l.length; d++)for (var r = l[d].groupData, c = 0; c < r.length; c++) {
                var u = t("#" + s + "_" + i + "_" + d + "_" + c);
                u.prop("disabled") === !1 && (e.checked ? n.selectedRows.push(r[c]) : n.selectedRows.splice(c, 1), u.prop("checked", e.checked))
            }
            e.checked ? t("#" + s + "TableMain tbody").addClass(o.lineSelectedClass) : t("#" + s + "TableMain tbody").removeClass(o.lineSelectedClass), t.unique(n.selectedRows)
        }, _selectCheckbox: function (e) {
            var s = e.id.split("_")[0], i = e.id.split("_")[1], n = e.id.split("_")[2], l = e.id.split("_")[3],
                o = t("#" + s).data(a).settings, d = o.data, r = this._getDefaults(this._defaults, o, "styleClass"),
                c = t("#" + s + "_" + i), u = t(t("#" + s + "SubTable" + n + " tbody")[l]);
            if (e.checked) u.addClass(r.lineSelectedClass), o.selectedRows.push(d[n].groupData[l]); else {
                u.removeClass(r.lineSelectedClass);
                for (var h in o.selectedRows)o.selectedRows[h].uuuid === d[n].groupData[l].uuuid && o.selectedRows.splice(h, 1)
            }
            o.selectedRows.length === o.length ? c.prop("checked", !0) : c.prop("checked", !1)
        }, _getRow: function (e, a, s) {
            var i = {};
            for (var n in a) {
                var l = a[n].groupData;
                for (var o in l)s === l[o].uuuid && (i.data = l[o], i.$row = t(t("#" + e + "SubTable" + n + " tbody")[o]))
            }
            return i
        }, _getDefaults: function (t, e, a) {
            if ("styleClass" === a) {
                ...
                e.styleClass = {};
                for (var s in t[a])e.styleClass[s] = e.theme + "-" + t.styleClass[s]
            } else if (null === e[a] || void 0 === e[a])return t[a];
            return e[a]
        }, _strToInt: function (t) {
            return !!t && parseInt(t.substring(0, t.length - 2))
        }, _updateTable: function (e, a, s) {
            var i = this._getInst(e), n = i.id, l = i.settings;
            if (s) {
                var o = l.data, d = l.colModel, r = this._getRow(n, o, a);
                t.extend(r.data, s);
                for (var c = 0; c < d.length; c++)if ("checkbox" !== d[c].type) {
                    var u = d[c].index;
                    r.$row.find("td")[c].innerHTML = r.data[u] ? r.data[u] : "&nbsp;"
                }
                l.expendRow && t(r.$row.find("tr")[1]).find("td").html(s[l.expendRow.index] ? s[l.expendRow.index] : "&nbsp;")
            } else if (a.height) {
                var h = a.height;
                t("#" + n + "TableMain").height(h), l.height = h
            } else l.data = a.data, this._build(e)
        }, _getRowsTable: function (t, e, a) {
            var s = this._getInst(t), i = s.settings;
            if (!e)return i.selectedRows;
            for (var n = [], l = 0; l < i.data.length; l++) {
                var o = i.data[l].groupData;
                for (var d in o)o[d][e] === a && n.push(o[d])
            }
            return n
        }, _destroyTable: function (e) {
            var s = this._getInst(e);
            t.removeData(e, a), t("#" + s.id).remove()
        }, _selectedTable: function (e, a) {
            var s = this._getInst(e), i = s.id, n = s.settings, l = s.settings.data,
                o = this._getDefaults(this._defaults, n, "styleClass");
            for (var d in l) {
                var r = l[d].groupData;
                for (var c in r)if (a === r[c].uuuid) {
                    n.selectedRows.push(r[c]), t.unique(n.selectedRows);
                    var u = t(t("#" + i + "SubTable" + d + " tbody")[c]);
                    u.addClass(o.lineSelectedClass), u.find("input").prop("checked", !0)
                }
            }
        }, _unSelectedTable: function (e, a) {
            var s = this._getInst(e), i = s.id, n = s.settings, l = s.settings.data,
                o = this._getDefaults(this._defaults, n, "styleClass");
            for (var d in l) {
                var r = l[d].groupData;
                for (var c in r)if (a === r[c].uuuid) {
                    for (var u = n.selectedRows, h = 0; h < u.length; h++)u[h].uuuid === a && u.splice(h, 1);
                    var p = t(t("#" + i + "SubTable" + d + " tbody")[c]);
                    p.removeClass(o.lineSelectedClass), p.find("input").prop("checked", !1)
                }
            }
        }
    }), t.fn.table = function (e) {
        var a = Array.prototype.slice.call(arguments);
        return "string" == typeof e ? (a.shift(), t.table["_" + e + "Table"].apply(t.table, [this[0]].concat(a))) : this.each(function () {
            t.table._attach(this, e)
        })
    }, t.table = new s, window["DP_jQuery_" + e] = t
}(jQuery), function (t) {
    t.fn.extend({dialog: {version: "0.0.1.7", author: "lly219@gmail.com"}});
    var e = (new Date).getTime(), a = "dialog", s = function () {
        this._defaults = {
            styleClass: {
    ...
    t.extend(s.prototype, {
        _attach: function (e, s) {
            e.id || (this.uuid++, e.id = "dp" + this.uuid);
            var i = this._newInst(t(e));
            i.settings = t.extend({}, s || {}), t.data(e, a, i), this._init(e)
        }, _newInst: function (t) {
            var e = t[0].id.replace(/([^A-Za-z0-9_])/g, "\\\\$1");
            return {id: e}
        }, _getInst: function (e) {
        ...
        }, _destroyDialog: function (e) {
            var s = t.dialog._getInst(e), i = s.id;
            t.removeData(e, a), t(e).prependTo("#" + i + "Wrap").unwrap(), t(e).removeAttr("style");
            var n = this._getDefaults(t.dialog._defaults, s.settings, "styleClass");
            t("." + n.background).remove(), t("#" + i + "Dialog").remove()
        }, _init: function (e) {
            var a = this._getInst(e), s = a.id, i = a.settings, n = t(window).height(), l = t(window).width(),
                o = this._getDefaults(t.dialog._defaults, i, "styleClass"), d = i.height ? i.height : parseInt(.6 * n),
                r = i.width ? i.width : parseInt(.6 * l);
            i.title = i.title ? i.title : "", i.okText = i.okText ? i.okText : "Ok", i.cancelText = i.cancelText ? i.cancelText : "Cancel";
            var c = "",
                u = "<div class='" + o.headerBg + "'><div class='" + o.title + "'>" + i.title + "</div><a href='javascript:void(0);' class='" + o.closeIcon + "'></a></div>";
            i.hideFooter || (c = "<a href='javascript:void(0);'>" + i.okText + "</a><a href='javascript:void(0);'>" + i.cancelText + "</a>");
            var h = "<div id='" + s + "Dialog' class='" + o.panel + "' style='width: " + (r + 26) + "px;' onselectstart='return false;'>" + u + "<div class='" + o.main + "'><div style='overflow: auto; height: " + d + "px;'></div><div class='" + o.footer + "'>" + c + "</div></div>",
                p = "";
            if (i.modal && 0 === t("." + o.background).length) {
                var g = n < document.documentElement.scrollHeight ? document.documentElement.scrollHeight : n;
                p = "<div style='height:" + g + "px;' class='" + o.background + "'></div>"
            }
            t("#" + s).wrap("<div id='" + s + "Wrap'></div>");
            var f = t(e).clone(!0);
            t(e).remove(), t("body").append(p + h), t(t("#" + s + "Dialog ." + o.main + " div").get(0)).append(f), t(f).show();
            var v = "", _ = "", b = t("#" + s + "Dialog");
            i.position ? (v = i.position.top, _ = i.position.left) : (v = parseInt((n - d) / 2), _ = parseInt((l - r) / 2)), b.css({
                top: v + "px",
                left: _ + "px"
            }), t("#" + s + "Dialog ." + o.closeIcon).bind("click", function () {
                t.dialog._close(s, i)
            });
            var m = t("#" + s + "Dialog ." + o.footer + " a");
            t(m.get(1)).bind("click", function () {
                t.dialog._close(s, i)
            }), t(m.get(0)).bind("click", function () {
                (void 0 === i.ok || i.ok()) && t.dialog._close(s, i)
            }), this._bindMove(s, o.headerBg, d, r), t(window).keyup(function (e) {
                27 === e.keyCode && t.dialog._close(s, i)
            })
        }, _bindMove: function (e, a) {
            t("#" + e + "Dialog ." + a).mousedown(function (a) {
                var s = document;
                a || (a = window.event);
                var i = document.getElementById(e + "Dialog"), n = a.clientX - parseInt(i.style.left),
                    l = a.clientY - parseInt(i.style.top);
                s.ondragstart = "return false;", s.onselectstart = "return false;", s.onselect = "document.selection.empty();", this.setCapture ? this.setCapture() : window.captureEvents && window.captureEvents(Event.MOUSEMOVE | Event.MOUSEUP), s.onmousemove = function (e) {
                    e || (e = window.event);
                    var a = e.clientX - n, s = e.clientY - l;
                    a < 0 && (a = 0), a > t(window).width() - t(i).width() && (a = t(window).width() - t(i).width()), s < 0 && (s = 0), s > t(window).height() - t(i).height() && (s = t(window).height() - t(i).height()), i.style.left = a + "px", i.style.top = s + "px"
                }, s.onmouseup = function () {
                    this.releaseCapture ? this.releaseCapture() : window.captureEvents && window.captureEvents(Event.MOUSEMOVE | Event.MOUSEUP), s.onmousemove = null, s.onmouseup = null, s.ondragstart = null, s.onselectstart = null, s.onselect = null
                }
            })
        }, _close: function (e, a) {
            if ("none" !== t("#" + e + "Dialog").css("display") && (void 0 === a.close || a.close()) && (t("#" + e + "Dialog").hide(), a.modal)) {
                var s = this._getDefaults(t.dialog._defaults, a, "styleClass");
                t("." + s.background).hide()
            }
            ...
            var a = this._getInst(e), s = a.id, i = a.settings;
            if (t("#" + s + "Dialog").show(), i.modal) {
                var n = this._getDefaults(t.dialog._defaults, i, "styleClass");
                t("." + n.background).show()
            }
        }, _updateDialog: function (e, a) {
            var s = this._getInst(e), i = s.id, n = s.settings,
                l = this._getDefaults(t.dialog._defaults, n, "styleClass");
            t.extend(n, a);
            var o = t("#" + i + "Dialog");
            a.position && o.css({
                top: a.position.top,
                left: a.position.left
            }), a.width && (o.width(a.width + 26), o.find("." + l.main + " div")[0].style.width = a.width + "px", o.find("." + l.headerBg).width(a.width + 18)), a.height && (o.find("." + l.main + " div")[0].style.height = a.height + "px"), a.title && o.find("." + l.title).html(a.title), void 0 !== a.modal && (a.modal ? t("." + l.background).show() : t("." + l.background).hide()), void 0 !== a.hideFooter && (a.hideFooter ? o.find("." + l.footer).hide() : o.find("." + l.footer).show())
        }, _getDefaults: function (t, e, a) {
            if ("styleClass" === a) {
                if ("default" === e.theme || void 0 === e.theme)return t.styleClass;
                e.styleClass = {};
                ...
                if ("height" === a || "width" === a)return null === e[a] || void 0 === e[a] ? "auto" : e[a] + "px";
                if (null === e[a] || void 0 === e[a])return t[a]
            }
            return e[a]
        }
        ...
        var a = Array.prototype.slice.call(arguments);
        return "string" == typeof e ? (a.shift(), t.dialog["_" + e + "Dialog"].apply(t.dialog, [this[0]].concat(a))) : this.each(function () {
            t.dialog._attach(this, e)
        })
    }, t.dialog = new s, window["DP_jQuery_" + e] = t
}(jQuery), !function (t) {
    var e = (new Date).getTime(), a = "completed", s = function () {
        this._defaults = {
            styleClass: {
    ...
    t.extend(s.prototype, {
        _attach: function (e, s) {
            e.id || (this.uuid++, e.id = "dp" + this.uuid);
            var i = this._newInst(t(e));
            i.settings = t.extend({buttonText: "选择"}, s || {}), t.data(e, a, i), this._init(e)
        }, _newInst: function (t) {
            var e = t[0].id.replace(/([^A-Za-z0-9_])/g, "\\\\$1");
            return {id: e}
        }, _getInst: function (e) {
            ...
            var a = this._getInst(e), s = a.id, i = a.settings;
            this._buildHTML(s, i), t(document).click(function (e) {
                e.target.id !== s && t("#" + s + "SelectedPanel").hide()
            }), i.onlySelect || this._buildCheckboxPanel(s, i.data)
        }, _buildHTML: function (e, a) {
            var s = a.height + "px", i = this._getDefaults(t.completed._defaults, a, "styleClass"), n = t("#" + e),
                l = "";
            a.onlySelect || (l += "<button onclick=\"$('#" + e + "CheckboxPanel').toggle()\">" + a.buttonText + "</button>"), l += "<div id='" + e + "SelectedPanel' class='" + i.panelClass + "' style='height:" + s + ";'></div><div class='none " + i.ckClass + "' id='" + e + "CheckboxPanel'><div>", "object" == typeof a.data && a.data.sort(), n.after(l).bind("keyup", {settings: a}, this._keyupAction).bind("keydown", function (e) {
                a.chinese = e.keyCode, a.keydownVal = t(this).val()
            }).addClass(i.inputClass), a.tipNum = 0
        }, _keyupAction: function (e) {
            var a = e.data.settings, s = t.completed._getCurrentWord(this, a);
            if ("" === s.currentWord || 27 === e.keyCode || 16 === e.keyCode)return t("#" + this.id + "SelectedPanel").hide(), a.tipNum = 0, void(a.afterKeyup ? a.afterKeyup(e) : "");
            var i = t.completed._getMatchData(a.data, this.value, s.currentWord);
            if (38 === e.keyCode && (a.tipNum > 0 ? a.tipNum-- : a.tipNum = i.length - 1), 40 === e.keyCode && (a.tipNum < i.length - 1 ? a.tipNum++ : a.tipNum = 0), t.completed._buildSelectedPanel(this.id, i, a, s.currentWord), 13 === e.keyCode && i[a.tipNum] && 229 !== a.chinese) {
                var n = this.value;
                this.value = n.substring(0, s.startPos) + i[a.tipNum] + n.substring(s.endPos, n.length), t("#" + this.id + "SelectedPanel").hide(), a.chinese = void 0
            }
            38 !== e.keyCode && 40 !== e.keyCode && (a.tipNum = 0), a.afterKeyup ? a.afterKeyup(e) : ""
        }, _getCurrentWord: function (e, a) {
            var s = t(e).val(), i = !0, n = 0, l = 0, o = t.completed._defaults.separator;
            if ("" === s)return {currentWord: "", startPos: l, endPos: n};
            if (document.selection)try {
                var d = document.selection.createRange(), r = e.createTextRange();
                r.collapse(!0), r.select();
                var c = document.selection.createRange();
                c.setEndPoint("EndToEnd", d), a.curPos = c.text.length, d.select()
            } catch (t) {
                delete t
            } else a.curPos = e.selectionStart;
            for (var u = a.curPos, h = 0; h < s.length; h++)s.charAt(h) === o && h >= u && i && (n = h, i = !1);
            i === !0 && (i = !1, n = s.length);
            for (var p = n; p > -1; p--)s.charAt(p) === o && u > p && !i && (l = p + 1, i = !0);
            return {currentWord: s.substring(l, n), startPos: l, endPos: n}
        }, _getMatchData: function (e, a, s) {
            for (var i = a.split(t.completed._defaults.separator), n = [], l = 0; l < e.length; l++)if ("number" == typeof e[l] && (e[l] = e[l].toString()), e[l].toLowerCase().indexOf(s.toLowerCase()) > -1) {
                for (var o = !0, d = 0; d < i.length; d++)e[l] === i[d].toString() && e[l].toLowerCase() !== s.toLowerCase() && (o = !1);
                o && n.push(e[l])
            }
            return n
        }, _mousemoveSelectPanel: function (e, a, s) {
            t(e).parent().find("a").removeClass("selected"), e.className = "selected";
            var i = t.completed._getInst(document.getElementById(s));
            i.settings.tipNum = a
        }, _buildSelectedPanel: function (e, a, s, i) {
            var n = t("#" + e + "SelectedPanel");
            if (0 === a.length)return void n.html("").hide();
            s.tipNum >= a.length && (s.tipNum = 0);
            for (var l = "", o = 0; o < a.length; o++) {
                var d = "", r = a[o].replace(i, "<b>" + i + "</b>");
                s.tipNum === o && (d = "class='selected'"), l += "<a href='javascript:void(0);'                                         onmousemove=\"$.completed._mousemoveSelectPanel(this, " + o + ", '" + e + "');\"                                        " + d + ">" + r + "</a>"
            }
            n.html(l).show();
            var c = t("#" + e + "SelectedPanel a.selected");
            c.position().top + n.scrollTop() > 50 - c.height() && n.scrollTop(c.position().top + n.scrollTop() + c.height() - 50), c.position().top < 0 && n.scrollTop(n.scrollTop - c.height()), t("#" + e + "SelectedPanel a").click(function () {
                var a = document.getElementById(e), i = t.completed._getCurrentWord(document.getElementById(e), s),
                    n = t.completed._getMatchData(s.data, a.value, i.currentWord), l = a.value;
                a.value = l.substring(0, i.startPos) + n[s.tipNum] + l.substring(i.endPos, l.length), s.tipNum = 0, t(a).focus(), s.afterSelected ? s.afterSelected(t(this)) : ""
            })
        }, _buildCheckboxPanel: function (e, a) {
            for (var s = "", i = t("#" + e), n = 0; n < a.length; n++)s += "<span>" + a[n] + "</span>";
            t("#" + e + "CheckboxPanel").html(s + "<div class='clear'></div>"), t("#" + e + "CheckboxPanel").on("click", "span", function () {
                var t = i.val(), e = this.innerHTML;
                if ("selected" === this.className) {
                    this.className = "";
                    var a = t.substr(t.indexOf(e) + e.length, 1);
                    e === t || "," !== a ? i.val(t.replace(e, "")) : i.val(t.replace(e + ",", ""))
                } else this.className = "selected", "" === t.replace(/\s/g, "") || "," === t.substr(t.length - 1, 1) ? i.val(t + e) : i.val(t + "," + e)
            }), this._matchChecked(e), i.blur(function () {
                t.completed._matchChecked(e)
            })
        }, _matchChecked: function (e) {
            var a = t("#" + e).val().split(",");
            t("#" + e + "CheckboxPanel span").removeClass().each(function () {
                for (var t = 0; t < a.length; t++)this.innerHTML === a[t] && (this.className = "selected")
            })
        }, _updateDataCompleted: function (e, a, s) {
            var i = this._getInst(e), n = i.id, l = i.settings;
            l.data = s, t.completed._buildSelectedPanel(n, s, l, t("#" + n).val())
        }, _getDefaults: function (t, e, a) {
            if ("styleClass" === a) {
                if ("default" === e.theme || void 0 === e.theme)return t.styleClass;
                e.styleClass = {};
    ...
    }), t.fn.completed = function (e) {
        var a = Array.prototype.slice.call(arguments);
        return this.each(function () {
            "string" == typeof e ? t.completed["_" + e + "Completed"].apply(t.completed, [this].concat(a)) : t.completed._attach(this, e)
        })
    }, t.completed = new s, window["DP_jQuery_" + e] = t
}(jQuery), function (t) {
    t.fn.extend({tip: {version: "0.0.0.3", author: "lly219@gmail.com"}});
    var e = (new Date).getTime(), a = "tip", s = function () {
        this._defaults = {styleClass: {panel: "tip-panel"}}, this._settingsDataFormat = {}
    };
    t.extend(s.prototype, {
        _attach: function (e, s) {
            e.id || (this.uuid++, e.id = "dp" + this.uuid);
        ...
        }, _destroyTip: function (e) {
            t.removeData(e, a), t("#" + e.id + "Panel").remove()
        }, _init: function (e) {
            var a = this._getInst(e), s = a.id, i = a.settings, n = "",
                l = i.className ? i.className : this._getDefaults(t.tip._defaults, i, "styleClass").panel;
            n = "<div id='" + s + "Panel' class='" + l + "'>" + i.content + "</div>", t(i.appendId ? "#" + i.appendId : "body").append(n), t(e).hover(function () {
                t.tip._parsePosition(i, e), t("#" + s + "Panel").fadeIn("normal")
            }, function () {
                t("#" + s + "Panel").fadeOut("normal")
            })
        }, _optionTip: function (e, a, s) {
            var i = t.tip._getInst(e[0]), n = i.settings;
            return s && (n[a] = s, t("#" + e[0].id + "Panel").html(s)), n[a]
        }, _parsePosition: function (e, a) {
            var s = "", i = t("#" + a.id + "Panel");
            if (void 0 === e.left && void 0 === e.right && void 0 === e.bottom && void 0 === e.top && void 0 === e.position && (e.position = "bottom"), e.position) {
                var n = t(a);
                switch (e.position) {
                    case"top":
                        s = "left: " + parseInt(n.position().left) + "px; top: " + parseInt(n.position().top - i.height() - 6 - parseInt(n.css("padding-top")) - parseInt(i.css("padding-top"))) + "px;";
                        break;
                    case"bottom":
                        s = "left: " + parseInt(n.position().left) + "px; top: " + parseInt(n.position().top + n.height()) + "px;";
                        break;
                    default:
                        alert("Has no type!")
                }
                return void i.attr("style", s)
            }
            void 0 !== e.left && (s += "left:" + e.left + "px;"), void 0 !== e.top && (s += "top:" + e.top + "px;"), void 0 !== e.bottom && (s += "bottom:" + e.bottom + "px;"), void 0 !== e.right && (s += "right:" + e.right + "px;"), i.attr("style", s)
        }, _getDefaults: function (t, e, a) {
            if ("styleClass" === a) {
                if ("default" === e.theme || void 0 === e.theme)return t.styleClass;
                e.styleClass = {};
        ...
        var a = Array.prototype.slice.call(arguments);
        return "option" === e ? (a.shift(), t.tip["_" + e + "Tip"].apply(t.tip, [this].concat(a))) : this.each(function () {
            "string" == typeof e ? t.tip["_" + e + "Tip"].apply(t.tip, [this].concat(a)) : t.tip._attach(this, e)
        })
    }, t.tip = new s, window["DP_jQuery_" + e] = t
}(jQuery), function (t) {
    t.fn.extend({tabs: {version: "0.0.1.9", author: "lly219@gmail.com"}});
    var e = (new Date).getTime(), a = "tabs", s = function () {
    };
    t.extend(s.prototype, {
        _attach: function (e, s) {
            e.id || (this.uuid++, e.id = "dp" + this.uuid);
            var i = this._newInst(t(e));
            i.settings = t.extend({length: 0}, s || {}), t.data(e, a, i), this._init(e)
        }, _newInst: function (t) {
            var e = t[0].id.replace(/([^A-Za-z0-9_])/g, "\\\\$1");
            return {id: e}
        }, _getInst: function (e) {
            ...
            var a = this._getInst(e), s = a.settings, i = a.id, n = t(e).find("li");
            s.data = [];
            for (var l = 0, o = 0; l < n.length; l++)n[l].children[0].id && (s.data[o] = n[l].children[0].id.replace(i + "_", ""), o++)
        }, _setCurrentTabs: function (e, a) {
            var s = this._getInst(e), i = s.settings, n = s.id;
            if (!t("#" + n + "_" + a + " a").hasClass("tab-current"))for (var l = i.data, o = 0; o < l.length; o++) {
                var d = t("#" + n + "Panel_" + l[o]), r = t("#" + n + "_" + l[o]);
                a === l[o] ? (d.show(), r.find("a").addClass("tab-current")) : (d.hide(), r.find("a").removeClass("tab-current"))
            }
        }, _addTabs: function (e, a) {
            var s = this._getInst(e), i = s.settings, n = s.id;
            i.data.push(a.id);
            var l = "";
            l = a.hash ? "<a href='" + a.hash + "'>" + a.text + "</a>" : "<span>" + a.text + "</span>", t(a.target).before("<li><div id='" + n + "_" + a.id + "'>" + l + "</div></li>"), t("#" + n + "Panel").append("<div id=" + n + "Panel_" + a.id + " class='none'>" + a.content + "</div>")
        }, _removeTabs: function (e, a) {
            for (var s = this._getInst(e), i = s.settings.data, n = s.id, l = 0; l < i.length; l++)i[l] === a && i.splice(l, 1);
            t("#" + n + "_" + a).remove(), t("#" + n + "Pabel_" + a).remove()
        }
    }), t.fn.tabs = function (e) {
        var a = Array.prototype.slice.call(arguments);
        return "string" == typeof e ? (a.shift(), t.tabs["_" + e + "Tabs"].apply(t.tabs, [this[0]].concat(a))) : this.each(function () {
            t.tabs._attach(this, e)
        })
    }, t.tabs = new s, window["DP_jQuery_" + e] = t
}(jQuery);
!function (e) {
    ...
    function o(e) {
        var t = yt(e.display), r = e.options.lineWrapping,
    ...
    function u(e) {
        ...
        for (var n = 0; n < r.length; ++n) {
            var i = r[n], o = t.appendChild(Ui("div", null, "CodeMirror-gutter " + i));
    ...
    function p(e) {
        var t = e.display, r = t.gutters.offsetWidth, n = Math.round(e.doc.height + Ke(e.display));
        return {
    ...
    function g(e, t, r) {
        ...
        }), this.checkedZeroWidth = !1, bo && wo < 8 && (this.horiz.style.minHeight = this.vert.style.minWidth = "18px")
    }
    ...
    function w(e, t, r) {
        ...
        n = Math.floor(n - Ve(e));
        var i = r && null != r.bottom ? r.bottom : n + e.wrapper.clientHeight, o = ri(t, n), l = ri(t, i);
        if (r && r.ensure) {
            var s = r.ensure.from.line, a = r.ensure.to.line;
            s < o ? (o = s, l = ri(t, ni(Zn(t, s)) + e.wrapper.clientHeight)) : Math.min(a, t.lastLine()) >= l && (o = ri(t, ni(Zn(t, a)) - e.wrapper.clientHeight), l = a)
        }
    ...
    function x(e) {
        ...
        if (t.alignWidgets || t.gutters.firstChild && e.options.fixedGutter) {
            for (var n = L(t) - t.scroller.scrollLeft + e.doc.scrollLeft, i = t.gutters.offsetWidth, o = n + "px", l = 0; l < r.length; l++)if (!r[l].hidden) {
    ...
    function N(e, t) {
        for (var r = t.viewport, n = !0; (n && e.options.lineWrapping && t.oldDisplayWidth != Ye(e) || (r && null != r.top && (r = {top: Math.min(e.doc.height + Ke(e.display) - _e(e), r.top)}), t.visible = w(e.display, e.doc, r), !(t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo))) && M(e, t); n = !1) {
            O(e);
            var i = p(e);
            Pe(e), A(e, i), y(e, i)
        }
    ...
    function A(e, t) {
        e.display.sizer.style.minHeight = t.docHeight + "px", e.display.heightForcer.style.top = t.docHeight + "px", e.display.gutters.style.height = Math.max(t.docHeight + e.display.barHeight + Xe(e), t.clientHeight) + "px"
    }
    ...
    function O(e) {
        for (var t = e.display, r = t.lineDiv.offsetTop, n = 0; n < t.view.length; n++) {
            ...
            if (!o.hidden) {
                ...
                if (i < 2 && (i = yt(t)), (a > .001 || a < -.001) && (ei(o.line, i), D(o.line), o.rest))for (var u = 0; u < o.rest.length; u++)D(o.rest[u])
            }
        }
    }
    ...
    function I(e) {
        return e.node == e.text && (e.node = Ui("div", null, null, "position: relative"), e.text.parentNode && e.text.parentNode.replaceChild(e.node, e.text), e.node.appendChild(e.text), bo && wo < 8 && (e.node.style.zIndex = 2)), e.node
    }
    ...
    function R(e, t) {
        var r = t.text.className, n = F(e, t);
    ...
    function G(e, t, r, n) {
        ...
        if (e.options.lineNumbers || o) {
            ...
            if (e.display.input.setUneditable(l), i.insertBefore(l, t.text), t.line.gutterClass && (l.className += " " + t.line.gutterClass), !e.options.lineNumbers || o && o["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(Ui("div", S(e.options, r), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + n.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))), o)for (var s = 0; s < e.options.gutters.length; ++s) {
                var a = e.options.gutters[s], u = o.hasOwnProperty(a) && o[a];
    ...
    function j(e, t, r, n, i) {
        if (t.widgets)for (var o = I(r), l = 0, s = t.widgets; l < s.length; ++l) {
            var a = s[l], u = Ui("div", [a.node], "CodeMirror-linewidget");
    ...
    function Z(e, t, r, n, i) {
        ...
        if (l && n.ranges.length > 1)if (Ro && Ro.join("\n") == t) {
        ...
        for (var u = n.ranges.length - 1; u >= 0; u--) {
            var c = n.ranges[u], h = c.from(), f = c.to();
    ...
    function Q(e, t) {
        if (e.clipboardData && e.clipboardData.getData("text/html") || 2 === e.clipboardData.items.length) {
            var r = Util.processClipBoard(e.clipboardData, t);
            return e.preventDefault(), t.isReadOnly() || t.options.disableInput || Wt(t, function () {
                Z(t, r, 0, null, "paste")
            }), !0
        }
    }
    ...
    function ee(e) {
        for (var t = [], r = [], n = 0; n < e.doc.sel.ranges.length; n++) {
            var i = e.doc.sel.ranges[n].head.line, o = {anchor: zo(i, 0), head: zo(i + 1, 0)};
    ...
    function oe(e, t) {
        ...
        var n = Zn(e.doc, t.line), i = qe(r, n, t.line), o = ii(n), l = "left";
        if (o) {
            var s = uo(o, t.ch);
            l = s % 2 ? "right" : "left"
        }
    ...
    function ae(e, t, r) {
        function n(t, r, n) {
            for (var i = -1; i < (c ? c.length : 0); i++)for (var o = i < 0 ? u.map : c[i], l = 0; l < o.length; l += 3) {
                var s = o[l + 2];
                if (s == t || s == r) {
                    var a = ti(i < 0 ? e.line : e.rest[i]), h = o[l] + n;
                    return (n < 0 || s != t) && (h = o[l + (n ? 1 : 0)]), zo(a, h)
                }
            }
        }
    ...
    function fe(e, t) {
        ...
        for (var n = 1; n < e.length; n++) {
            var i = e[n], o = e[n - 1];
            if (Fo(o.to(), i.from()) >= 0) {
                var l = $(o.from(), i.from()), s = _(o.to(), i.to()),
    ...
    function ve(e, t) {
        var r = e.ch;
        return null == r || r > t ? zo(e.line, t) : r < 0 ? zo(e.line, 0) : e
    }
    ...
    function Le(e, t, r) {
        ...
        return Dl(e, "beforeSelectionChange", e, n), e.cm && Dl(e.cm, "beforeSelectionChange", e.cm, n), n.ranges != t.ranges ? fe(n.ranges, n.ranges.length - 1) : t
    }

    function Te(e, t, r) {
        var n = e.history.done, i = Di(n);
    ...
    function Me(e, t, r) {
        (Ni(e, "beforeSelectionChange") || e.cm && Ni(e.cm, "beforeSelectionChange")) && (t = Le(e, t, r));
    ...
    function Ae(e, t, r, n) {
        for (var i, o = 0; o < t.ranges.length; o++) {
            var l = t.ranges[o], s = t.ranges.length == e.sel.ranges.length && e.sel.ranges[o],
                a = De(e, l.anchor, s && s.anchor, r, n), u = De(e, l.head, s && s.head, r, n);
        ...
        if (o.markedSpans)for (var l = 0; l < o.markedSpans.length; ++l) {
            ...
            if ((null == s.from || (a.inclusiveLeft ? s.from <= t.ch : s.from < t.ch)) && (null == s.to || (a.inclusiveRight ? s.to >= t.ch : s.to > t.ch))) {
                ...
                if (r) {
                    ...
                    if ((n < 0 ? a.inclusiveRight : a.inclusiveLeft) && (c = He(e, c, -n, o)), c && c.line == t.line && (u = Fo(c, r)) && (n < 0 ? u < 0 : u > 0))return Oe(e, c, t, n, i)
                }
                var h = a.find(n < 0 ? -1 : 1);
                return (n < 0 ? a.inclusiveLeft : a.inclusiveRight) && (h = He(e, h, n, o)), h ? Oe(e, h, t, n, i) : null
            }
        }
        return t
    }
    ...
    function He(e, t, r, n) {
        return r < 0 && 0 == t.ch ? t.line > e.first ? ge(e, zo(t.line - 1)) : null : r > 0 && t.ch == (n || Zn(e, t.line)).text.length ? t.line < e.first + e.size - 1 ? zo(t.line + 1, 0) : null : new zo(t.line, t.ch + r)
    }
    ...
    function Ee(e, t) {
        for (var r = e.doc, n = {}, i = n.cursors = document.createDocumentFragment(), o = n.selection = document.createDocumentFragment(), l = 0; l < r.sel.ranges.length; l++)if (t !== !1 || l != r.sel.primIndex) {
            var s = r.sel.ranges[l], a = s.empty();
    ...
    function ze(e, t, r) {
        function n(e, t, r, n) {
            t < 0 && (t = 0), t = Math.round(t), n = Math.round(n), s.appendChild(Ui("div", null, "CodeMirror-selected", "position: absolute; left: " + e + "px; top: " + t + "px; width: " + (null == r ? c - e : r) + "px; height: " + (n - t) + "px"))
        }
        ...
        var o = e.display, l = e.doc, s = document.createDocumentFragment(), a = je(e.display), u = a.left,
            c = Math.max(o.sizerWidth, Ye(e) - o.sizer.offsetLeft) - a.right, h = t.from(), f = t.to();
        if (h.line == f.line) i(h.line, h.ch, f.ch); else {
            var d = Zn(l, h.line), p = Zn(l, f.line), g = yn(d) == yn(p),
                v = i(h.line, h.ch, g ? d.text.length + 1 : null).end, m = i(f.line, g ? 0 : null, f.ch).start;
    ...
    function Be(e) {
        ...
        if (t.frontier < t.first && (t.frontier = t.first), !(t.frontier >= e.display.viewTo)) {
            var r = +new Date + e.options.workTime, n = sl(t.mode, Ue(e, t.frontier)), i = [];
            t.iter(t.frontier, Math.min(t.first + t.size, e.display.viewTo + 500), function (o) {
                if (t.frontier >= e.display.viewFrom) {
                    var l = o.styles, s = o.text.length > e.options.maxHighlightLength,
    ...
    function Ue(e, t, r) {
        ...
        var o = Ge(e, t, r), l = o > n.first && Zn(n, o - 1).stateAfter;
    ...
    function $e(e, t, r) {
        var n = e.options.lineWrapping, i = n && Ye(e);
    ...
    function Ze(e, t) {
        t = yn(t);
        var r = ti(t), n = e.display.externalMeasured = new Ht(e.doc, t, r);
        n.lineN = r;
    ...
    function rt(e, t, r) {
        for (var n, i, o, l, s = 0; s < e.length; s += 3) {
            ...
            if (t < a ? (i = 0, o = 1, l = "left") : t < u ? (i = t - a, o = i + 1) : (s == e.length - 3 || t == u && e[s + 3] > t) && (o = u - a, i = o - 1, t >= u && (l = "right")), null != i) {
                if (n = e[s + 2], a == u && r == (n.insertLeft ? "left" : "right") && (l = r),
                    "left" == r && 0 == i)for (; s && e[s - 2] == e[s - 3] && e[s - 1].insertLeft;)n = e[(s -= 3) + 2], l = "left";
                if ("right" == r && i == u - a)for (; s < e.length - 3 && e[s + 3] == e[s + 4] && !e[s + 5].insertLeft;)n = e[(s += 3) + 2], l = "right";
                break
            }
        }
        return {node: n, start: i, end: o, collapse: l, coverStart: a, coverEnd: u}
    }

    function nt(e, t, r, n) {
        var i, o = rt(t.map, r, n), l = o.node, s = o.start, a = o.end, u = o.collapse;
        if (3 == l.nodeType) {
            for (var c = 0; c < 4; c++) {
                for (; s && Gi(t.line.text.charAt(o.coverStart + s));)--s;
                for (; o.coverStart + a < o.coverEnd && Gi(t.line.text.charAt(o.coverStart + a));)++a;
                if (bo && wo < 9 && 0 == s && a == o.coverEnd - o.coverStart) i = l.parentNode.getBoundingClientRect(); else if (bo && e.options.lineWrapping) {
    ...
    function ht(e, t, r) {
        ...
        if ("page" == r) n -= at(), i -= ut(); else if ("local" == r || !r) {
    ...
    function dt(e, t, r, n, i, o) {
        ...
        var a = ii(n), u = t.ch;
        if (!a)return l(u);
        var c = uo(a, u), h = s(u, c);
        return null != os && (h.other = s(u, os)), h
    }

    function pt(e, t) {
        var r = 0, t = ge(e.doc, t);
        e.options.lineWrapping || (r = bt(e.display) * t.ch);
        var n = Zn(e.doc, t.line), i = ni(n) + Ve(e.display);
    ...
    function vt(e, t, r) {
        var n = e.doc;
        if (r += e.display.viewOffset, r < 0)return gt(n.first, 0, !0, -1);
        var i = ri(n, r), o = n.first + n.size - 1;
        if (i > o)return gt(n.first + n.size - 1, Zn(n, o).text.length, !0, 1);
        t < 0 && (t = 0);
        for (var l = Zn(n, i); ;) {
            var s = mt(e, l, i, t, r), a = vn(l), u = a && a.find(0, !0);
    ...
    function mt(e, t, r, n, i) {
        ...
        var l = i - ni(t), s = !1, a = 2 * e.display.wrapper.clientWidth, u = et(e, t), c = ii(t), h = t.text.length,
            f = no(t), d = io(t), p = o(f), g = s, v = o(d), m = s;
        if (n > v)return gt(r, d, m, 1);
        for (; ;) {
            if (c ? d == f || d == ho(t, f, 1) : d - f <= 1) {
                for (var y = n < p || n - p <= v - n ? f : d, b = n - (y == f ? p : v); Gi(t.text.charAt(y));)++y;
                var w = gt(r, y, y == f ? g : m, b < -1 ? -1 : b > 1 ? 1 : 0);
                return w
            }
            var x = Math.ceil(h / 2), C = f + x;
            if (c) {
                C = f;
                for (var S = 0; S < x; ++S)C = ho(t, C, 1)
            }
            var L = o(C);
    ...
    function yt(e) {
        ...
        if (null == Bo) {
            Bo = Ui("pre");
            for (var t = 0; t < 49; ++t)Bo.appendChild(document.createTextNode("x")), Bo.appendChild(Ui("br"));
    ...
    function bt(e) {
        ...
        var t = Ui("span", "xxxxxxxxxx"), r = Ui("pre", [t]);
        Ki(e.measure, r);
    ...
    function wt(e) {
        e.curOp = {
            ...
            focus: !1,
            id: ++jo
        }, Ko ? Ko.ops.push(e.curOp) : e.curOp.ownsGroup = Ko = {ops: [e.curOp], delayedCallbacks: []}
    }
    ...
    function Nt(e) {
        ...
        if (o)for (var s = 0; s < o.length; ++s)o[s].lines.length || Dl(o[s], "hide");
        if (l)for (var s = 0; s < l.length; ++s)l[s].lines.length && Dl(l[s], "unhide");
    ...
    function Et(e, t, r, n) {
        ...
        var i = e.display;
        if (n && r < i.viewTo && (null == i.updateLineNumbers || i.updateLineNumbers > t) && (i.updateLineNumbers = t), e.curOp.viewChanged = !0, t >= i.viewTo) Io && wn(e.doc, t) < i.viewTo && zt(e); else if (r <= i.viewFrom) Io && xn(e.doc, r + n) > i.viewFrom ? zt(e) : (i.viewFrom += n, i.viewTo += n); else if (t <= i.viewFrom && r >= i.viewTo) zt(e); else if (t <= i.viewFrom) {
            var o = Rt(e, r, r + n, 1);
            ...
            var l = Rt(e, t, t, -1), s = Rt(e, r, r + n, 1);
    ...
    function Rt(e, t, r, n) {
        var i, o = Ft(e, t), l = e.display.view;
        if (!Io || r == e.doc.first + e.doc.size)return {index: o, lineN: r};
    ...
    function Ut(e) {
        ...
        var i = e.display;
        Wl(i.scroller, "mousedown", At(e, Yt)), bo && wo < 11 ? Wl(i.scroller, "dblclick", At(e, function (t) {
            if (!ki(e, t)) {
                var r = Xt(e, t);
        ...
        var o, l = {end: 0};
        Wl(i.scroller, "touchstart", function (t) {
            if (!ki(e, t) && !r(t)) {
                clearTimeout(o);
                var n = +new Date;
                i.activeTouch = {
    ...
    function Vt(t, r, n) {
        var i = n && n != e.Init;
        if (!r != !i) {
            var o = t.display.dragFunctions, l = r ? Wl : Ol;
    ...
    function Yt(e) {
        ...
        if (!(ki(t, e) || r.activeTouch && r.input.supportsTouch())) {
    ...
    function $t(e, t, r, n) {
        var i = e.display, o = +new Date, l = At(e, function (s) {
    ...
    function qt(e, t, r, n, i) {
        function o(t) {
            if (0 != Fo(v, t))if (v = t, "rect" == n) {
                for (var i = [], o = e.options.tabSize, l = Rl(Zn(u, r.line).text, r.ch, o), s = Rl(Zn(u, t.line).text, t.ch, o), a = Math.min(l, s), d = Math.max(l, s), p = Math.min(r.line, t.line), g = Math.min(e.lastLine(), Math.max(r.line, t.line)); p <= g; p++) {
                    var m = Zn(u, p).text, y = Bl(m, a, o);
                ...
                var b = c, w = b.anchor, x = t;
                if ("single" != n) {
                    if ("double" == n)var C = e.findWordAt(t); else var C = new he(zo(t.line, 0), ge(u, zo(t.line + 1, 0)));
        ...
        if (i && !t.shiftKey ? (h = u.sel.contains(r), c = h > -1 ? d[h] : new he(r, r)) : (c = u.sel.primary(), h = u.sel.primIndex), t.altKey) n = "rect", i || (c = new he(r, r)), r = Xt(e, t, !0, !0), h = -1; else if ("double" == n) {
        ...
        var v = r, m = a.wrapper.getBoundingClientRect(), y = 0, b = At(e, function (e) {
            Ci(e) ? l(e) : s(e)
        }), x = At(e, s);
    ...
    function Zt(e, t, r, n) {
        ...
        for (var a = 0; a < e.options.gutters.length; ++a) {
            ...
            if (u && u.getBoundingClientRect().right >= i) {
                var c = ri(e.doc, o), h = e.options.gutters[a];
    ...
    function Jt(e) {
        ...
        if (rr(t), !ki(t, e) && !jt(t.display, e)) {
            kl(e), bo && (Xo = +new Date);
            var r = Xt(t, e, !0), n = e.dataTransfer.files;
            if (r && !t.isReadOnly())if (n && n.length && window.FileReader && window.File)for (var i = n.length, o = Array(i), l = 0, s = function (e, n) {
                if (!t.options.allowDropFileTypes || Hi(t.options.allowDropFileTypes, e.type) != -1) {
                ...
                try {
                    ...
                    if (o) {
                        ...
                        if (Me(t.doc, de(r, r)), u)for (var a = 0; a < u.length; ++a)Or(t.doc, "", u[a].anchor, u[a].head, "drag");
    ...
    function nr(e, t) {
        Math.abs(e.doc.scrollTop - t) < 2 || (e.doc.scrollTop = t, vo || W(e, {top: t}), e.display.scroller.scrollTop != t && (e.display.scroller.scrollTop = t), e.display.scrollbars.setScrollTop(t), vo && W(e), Re(e, 100))
    }
    ...
    function or(e, t) {
        var r = $o(t), n = r.x, i = r.y, o = e.display, l = o.scroller, s = l.scrollWidth > l.clientWidth,
            a = l.scrollHeight > l.clientHeight;
        if (n && s || i && a) {
            if (i && Ao && xo)e:for (var u = t.target, c = o.view; u != l; u = u.parentNode)for (var h = 0; h < c.length; h++)if (c[h].node == u) {
            ...
            if (i && null != _o) {
                var f = i * _o, d = e.doc.scrollTop, p = d + o.wrapper.clientHeight;
                f < 0 ? d = Math.max(0, d + f - 50) : p = Math.min(e.doc.height, p + f + 50), W(e, {top: d, bottom: p})
            }
            Yo < 20 && (null == o.wheelStartX ? (o.wheelStartX = l.scrollLeft, o.wheelStartY = l.scrollTop, o.wheelDX = n, o.wheelDY = i, setTimeout(function () {
    ...
    function ur(e, t) {
        ...
        return !!r && (t.shiftKey && !e.state.keySeq ? ar(e, "Shift-" + r, t, function (t) {
                    ...
                    if ("string" == typeof t ? /^go[A-Z]/.test(t) : t.motion)return lr(e, t)
                }) : ar(e, r, t, function (t) {
                return lr(e, t)
            }))
    }
    ...
    function hr(e) {
        ...
        if (t.curOp.focus = ji(), !ki(t, e)) {
            bo && wo < 11 && 27 == e.keyCode && (e.returnValue = !1);
            var r = e.keyCode;
    ...
    function Sr(e, t, r) {
        for (var n = [], i = zo(e.first, 0), o = i, l = 0; l < t.length; l++) {
            var s = t[l], a = Cr(s.from, i, o), u = Cr(Qo(s), i, o);
            if (i = s.to, o = u, "around" == r) {
                var c = e.sel.ranges[l], h = Fo(c.head, c.anchor) < 0;
    ...
    function Tr(e, t, r) {
        ...
        if (!(Ni(e, "beforeChange") || e.cm && Ni(e.cm, "beforeChange")) || (t = Lr(e, t, !0))) {
            ...
            if (n)for (var i = n.length - 1; i >= 0; --i)kr(e, {
                from: n[i].from,
                to: n[i].to,
                text: i ? [""] : t.text
            }); else kr(e, t)
    ...
    function kr(e, t) {
        if (1 != t.text.length || "" != t.text[0] || 0 != Fo(t.from, t.to)) {
            ...
            var n = [];
            $n(e, function (e, r) {
                r || Hi(n, e.history) != -1 || (bi(e.history, t), n.push(e.history)), Wr(e, t, null, on(e, t))
            })
        }
    }
        ...
        if (!e.cm || !e.cm.state.suppressEdits) {
            ...
            if (a != l.length) {
                for (i.lastOrigin = i.lastSelOrigin = null; n = l.pop(), n.ranges;) {
                    if (fi(n, s), r && !n.equals(e.sel))return void ke(e, n, {clearRedo: !1});
                    o = n
                }
                var u = [];
                fi(o, s), s.push({
                ...
                for (var c = Ni(e, "beforeChange") || e.cm && Ni(e.cm, "beforeChange"), a = n.changes.length - 1; a >= 0; --a) {
                    ...
                    u.push(li(e, h));
                    var f = a ? xr(e, h) : Di(l);
                    Wr(e, h, f, sn(e, h)), !a && e.cm && e.cm.scrollIntoView({from: h.from, to: Qo(h)});
                    var d = [];
                    $n(e, function (e, t) {
                        t || Hi(d, e.history) != -1 || (bi(e.history, h), d.push(e.history)), Wr(e, h, null, sn(e, h))
                    })
                }
            }
        }
    ...
    function Ar(e, t, r) {
        var n = e.doc, i = e.display, l = t.from, s = t.to, a = !1, u = l.line;
        ...
        var f = Ni(e, "changes"), d = Ni(e, "change");
        if (d || f) {
            var p = {from: l, to: s, text: t.text, removed: t.removed, origin: t.origin};
    ...
    function Or(e, t, r, n, i) {
        ...
        "string" == typeof t && (t = e.splitLines(t)), Tr(e, {from: r, to: n, text: t, origin: i})
    }
    ...
    function Hr(e, t, r, n) {
        null == n && (n = 0);
        for (var i = 0; i < 5; i++) {
            var o = !1, l = dt(e, t), s = r && r != t ? dt(e, r) : l,
    ...
    function Er(e, t, r, n, i) {
        var o = e.display, l = yt(e.display);
        r < 0 && (r = 0);
        var s = e.curOp && null != e.curOp.scrollTop ? e.curOp.scrollTop : o.scroller.scrollTop, a = _e(e), u = {};
        i - r > a && (i = r + a);
        var c = e.doc.height + Ke(o), h = r < l, f = i > c - l;
        if (r < s) u.scrollTop = h ? 0 : r; else if (i > s + a) {
            var d = Math.min(r, (f ? c : i) - a);
            d != s && (u.scrollTop = d)
        }
        var p = e.curOp && null != e.curOp.scrollLeft ? e.curOp.scrollLeft : o.scroller.scrollLeft,
            g = Ye(e) - (e.options.fixedGutter ? o.gutters.offsetWidth : 0), v = n - t > g;
    ...
    function Rr(e, t, r, n) {
        ...
        var l = e.options.tabSize, s = Zn(o, t), a = Rl(s.text, null, l);
        ...
        if (f < u && (h += Oi(u - f)), h != c)return Or(o, h, zo(t, 0), zo(t, c.length), "+input"), s.stateAfter = null, !0;
    ...
    function Ur(e, t, r, n, i) {
        function o() {
            var t = s + r;
            return !(t < e.first || t >= e.first + e.size) && (s = t, c = Zn(e, t))
        }
        ...
        function l(e) {
            ...
            if (null == t) {
                if (e || !o())return !1;
                a = i ? (r < 0 ? io : no)(c) : r < 0 ? c.text.length : 0
            } else a = t;
            return !0
        }

        var s = t.line, a = t.ch, u = r, c = Zn(e, s);
        if ("char" == n) l(); else if ("column" == n) l(!0); else if ("word" == n || "group" == n)for (var h = null, f = "group" == n, d = e.cm && e.cm.getHelper(t, "wordChars"), p = !0; !(r < 0) || l(!p); p = !1) {
        ...
        var m = De(e, zo(s, a), t, u, !0);
        return Fo(t, m) || (m.hitSide = !0), m
    }
    ...
    function Vr(e, t, r, n) {
        ...
        if ("page" == n) {
            ...
            i = t.top + r * (s - (r < 0 ? 1.5 : .5) * yt(e.display))
    ...
    function Yr(e, t, r, n, i) {
        ...
        if (e.iter(a, r.line + 1, function (e) {
            ...
            if (s && (u.curOp.updateMaxLine = !0), o.collapsed) Et(u, t.line, r.line + 1); else if (o.className || o.title || o.startStyle || o.endStyle || o.css)for (var c = t.line; c <= r.line; c++)It(u, c, "text");
    ...
    function _r(e, t, r, n, i) {
        n = zi(n), n.shared = !1;
        var o = [Yr(e, t, r, n, i)], l = o[0], s = n.widgetNode;
    ...
    function Zr(e) {
        for (var t = 0; t < e.length; t++) {
            ...
            for (var i = 0; i < r.markers.length; i++) {
                var o = r.markers[i];
                Hi(n, o.doc) == -1 && (o.parent = null, r.markers.splice(i--, 1))
            }
        }
    }
    ...
    function on(e, t) {
        ...
        if (!r && !n)return null;
        var i = t.from.ch, o = t.to.ch, l = 0 == Fo(t.from, t.to), s = rn(r, i, l), a = nn(n, o, l),
            u = 1 == t.text.length, c = Di(t.text).length + (u ? i : 0);
        ...
        if (!u) {
            ...
            if (v > 0 && s)for (var h = 0; h < s.length; ++h)null == s[h].to && (g || (g = [])).push(new Qr(s[h].marker, null, null));
    ...
    function an(e, t, r) {
        ...
        if (e.iter(t.line, r.line + 1, function (e) {
                if (e.markedSpans)for (var t = 0; t < e.markedSpans.length; ++t) {
                    ...
                    !r.readOnly || n && Hi(n, r) != -1 || (n || (n = [])).push(r)
                }
            }), !n)return null;
        for (var i = [{
            from: t,
            ...
            if (!(Fo(u.to, s.from) < 0 || Fo(u.from, s.to) > 0)) {
                var c = [a, 1], h = Fo(u.from, s.from), f = Fo(u.to, s.to);
    ...
    function dn(e, t) {
        ...
        if (0 != r)return r;
        var n = e.find(), i = t.find(), o = Fo(n.from, i.from) || hn(e) - hn(t);
        if (o)return -o;
    ...
    function mn(e, t, r, n, i) {
        var o = Zn(e, t), l = Io && o.markedSpans;
        if (l)for (var s = 0; s < l.length; ++s) {
            var a = l[s];
            if (a.marker.collapsed) {
                var u = a.marker.find(0), c = Fo(u.from, r) || hn(a.marker) - hn(i),
                    h = Fo(u.to, n) || fn(a.marker) - fn(i);
                if (!(c >= 0 && h <= 0 || c <= 0 && h >= 0) && (c <= 0 && (Fo(u.to, r) > 0 || a.marker.inclusiveRight && i.inclusiveLeft) || c >= 0 && (Fo(u.from, n) < 0 || a.marker.inclusiveLeft && i.inclusiveRight)))return !0
            }
        }
    }
    ...
    function Dn(e, t, r, n) {
        function i(e) {
            return {start: h.start, end: h.pos, string: h.current(), type: o || null, state: e ? sl(l.mode, c) : c}
        }

        var o, l = e.doc, s = l.mode;
        t = ge(l, t);
        var a, u = Zn(l, t.line), c = Ue(e, t.line, r), h = new pl(u.text, e.options.tabSize);
        for (n && (a = []); (n || h.pos < t.ch) && !h.eol();)h.start = h.pos, o = On(s, h, c), n && a.push(i(!0));
        return n ? a : i()
    }
    ...
    function Hn(e, t, r, n, i, o, l) {
        ...
        var a, u = 0, c = null, h = new pl(t, e.options.tabSize), f = e.options.addModeClass && [null];
    ...
    function Pn(e, t, r, n) {
        ...
        for (var l = 0; l < e.state.overlays.length; ++l) {
            var s = e.state.overlays[l], a = 1, u = 0;
            Hn(e, t.text, s.mode, !0, function (e, t) {
                for (var r = a; u < e;) {
                    var n = i[a];
                    n > e && i.splice(a, 1, e, i[a + 1], n), a += 2, u = Math.min(e, n)
                }
                if (t)if (s.opaque) i.splice(r, a - r, e, "cm-overlay " + t), a = r + 2; else for (; r < a; r += 2) {
                    var o = i[r + 1];
    ...
    function En(e, t, r) {
        if (!t.styles || t.styles[0] != e.state.modeGen) {
            var n = Ue(e, ti(t)), i = Pn(e, t, t.text.length > e.options.maxHighlightLength ? sl(e.doc.mode, n) : n);
    ...
    function Fn(e, t) {
        var r = Ui("span", null, null, xo ? "padding-right: .1px" : null), n = {
    ...
    function Bn(e, t, r, n, i, o, l) {
        if (t) {
            var s = e.splitSpaces ? t.replace(/ {3,}/g, Gn) : t, a = e.cm.state.specialChars, u = !1;
            if (a.test(t))for (var c = document.createDocumentFragment(), h = 0; ;) {
                a.lastIndex = h;
                var f = a.exec(t), d = f ? f.index - h : t.length - h;
                if (d) {
                    var p = document.createTextNode(s.slice(h, h + d));
                    bo && wo < 9 ? c.appendChild(Ui("span", [p])) : c.appendChild(p), e.map.push(e.pos, e.pos + d, p), e.col += d, e.pos += d
                }
                if (!f)break;
                if (h += d + 1, "\t" == f[0]) {
                    var g = e.cm.options.tabSize, v = g - e.col % g, p = c.appendChild(Ui("span", Oi(v), "cm-tab"));
                    ...
                    p.setAttribute("cm-text", f[0]), bo && wo < 9 ? c.appendChild(Ui("span", [p])) : c.appendChild(p), e.col += 1
                }
                e.map.push(e.pos, e.pos + 1, p), e.pos++
            } else {
                e.col += t.length;
                var c = document.createTextNode(s);
                e.map.push(e.pos, e.pos + t.length, c), bo && wo < 9 && (u = !0), e.pos += t.length
            }
            if (r || n || i || u || l) {
                var m = r || "";
                n && (m += n), i && (m += i);
    ...
    function Kn(e, t, r) {
        ...
        if (n)for (var l, s, a, u, c, h, f, d = i.length, p = 0, g = 1, v = "", m = 0; ;) {
            if (m == p) {
                ...
                for (var y, b = [], w = 0; w < n.length; ++w) {
                    ...
                    "bookmark" == C.type && x.from == p && C.widgetNode ? b.push(C) : x.from <= p && (null == x.to || x.to > p || C.collapsed && x.to == p && x.from == p) ? (null != x.to && x.to != p && m > x.to && (m = x.to, u = ""), C.className && (a += " " + C.className), C.css && (s = (s ? s + ";" : "") + C.css), C.startStyle && x.from == p && (c += " " + C.startStyle), C.endStyle && x.to == m && (y || (y = [])).push(C.endStyle, x.to), C.title && !h && (h = C.title), C.collapsed && (!f || dn(f.marker, C) < 0) && (f = x)) : x.from > p && m > x.from && (m = x.from)
                }
                if (y)for (var w = 0; w < y.length; w += 2)y[w + 1] == m && (u += " " + y[w]);
                if (!f || f.from == p)for (var w = 0; w < b.length; ++w)Vn(t, 0, b[w]);
                if (f && (f.from || 0) == p) {
        ...
        } else for (var g = 1; g < r.length; g += 2)t.addToken(t, i.slice(o, o = r[g]), zn(r[g + 1], t.cm.options))
    }
    ...
    function Xn(e, t, r, n) {
        ...
        function l(e, t) {
            for (var r = e, o = []; r < t; ++r)o.push(new bl(u[r], i(r), n));
            return o
        }

        var s = t.from, a = t.to, u = t.text, c = Zn(e, s.line), h = Zn(e, a.line), f = Di(u), d = i(u.length - 1),
            p = a.line - s.line;
        if (t.full) e.insert(0, l(0, u.length)), e.remove(u.length, e.size - u.length); else if (jn(e, t)) {
    ...
    function li(e, t) {
        var r = {from: Y(t.from), to: Qo(t), text: Qn(e, t.from, t.to)};
    ...
    function vi(e, t, r) {
        for (var n = 0, i = []; n < e.length; ++n) {
            var o = e[n];
            if (o.ranges) i.push(r ? ce.prototype.deepCopy.call(o) : o); else {
                var l = o.changes, s = [];
                i.push({changes: s});
                for (var a = 0; a < l.length; ++a) {
                    ...
                    if (s.push({
                            ...
                            to: c.to,
                            text: c.text
                        }), t)for (var h in c)(u = h.match(/^spans_(\d+)$/)) && Hi(t, Number(u[1])) > -1 && (Di(s)[h] = c[h], delete c[h])
                }
            }
        }
        return i
        ...
        for (var i = 0; i < e.length; ++i) {
            ...
            if (o.ranges) {
                ...
                for (var s = 0; s < o.changes.length; ++s) {
                    var a = o.changes[s];
                    if (r < a.from.line) a.from = zo(a.from.line + n, a.from.ch), a.to = zo(a.to.line + n, a.to.ch); else if (t <= a.to.line) {
                        l = !1;
                        break
                    }
                }
    ...
    function Mi(e) {
        ...
        if (t)for (var r = e.curOp.cursorActivityHandlers || (e.curOp.cursorActivityHandlers = []), n = 0; n < t.length; ++n)Hi(r, t[n]) == -1 && r.push(t[n])
    }
    ...
    function Ri(e, t) {
        return t ? !!(t.source.indexOf("\\w") > -1 && jl(e)) || t.test(e) : jl(e)
    }
    ...
    function Zi(e) {
        if (null == _l) {
            var t = Ui("span", "​");
            Ki(e, Ui("span", [t, document.createTextNode("x")])), 0 != e.firstChild.offsetHeight && (_l = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(bo && wo < 8))
        }
    ...
    function Qi(e) {
        if (null != $l)return $l;
        var t = Ki(e, document.createTextNode("AخA")), r = Vl(t, 0, 1).getBoundingClientRect();
    ...
    function Ji(e) {
        ...
        var t = Ki(e, Ui("span", "x")), r = t.getBoundingClientRect(), n = Vl(t, 0, 1).getBoundingClientRect();
    ...
    function so(e, t) {
        var r = oo(e, t.line), n = Zn(e.doc, r.line), i = ii(n);
        if (!i || 0 == i[0].level) {
    ...
    function fo(e, t, r, n) {
        var i = t + r;
        if (n)for (; i > 0 && Gi(e.text.charAt(i));)i += r;
        return i < 0 || i > e.text.length ? null : i
    }

    var po = navigator.userAgent, go = navigator.platform, vo = /gecko\/\d/i.test(po), mo = /MSIE \d/.test(po),
        yo = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(po), bo = mo || yo,
        wo = bo && (mo ? document.documentMode || 6 : yo[1]), xo = /WebKit\//.test(po),
        Co = xo && /Qt\/\d+\.\d+/.test(po), So = /Chrome\//.test(po), Lo = /Opera\//.test(po),
        To = /Apple Computer/.test(navigator.vendor), ko = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(po),
        Mo = /PhantomJS/.test(po), No = /AppleWebKit/.test(po) && /Mobile\/\w+/.test(po),
        Wo = No || /Android|webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(po), Ao = No || /Mac/.test(go),
        Oo = /win/i.test(go), Do = Lo && po.match(/Version\/(\d*\.\d*)/);
    Do && (Do = Number(Do[1])), Do && Do >= 15 && (Lo = !1, xo = !0);
    var Ho = Ao && (Co || Lo && (null == Do || Do < 12.11)), Po = vo || bo && wo >= 9, Eo = !1, Io = !1;
    g.prototype = zi({
        update: function (e) {
    ...
    }, v.prototype), e.scrollbarModel = {native: g, null: v}, T.prototype.signal = function (e, t) {
    ...
    re.prototype = zi({
        init: function (e) {
            ...
            e.wrapper.insertBefore(i, e.wrapper.firstChild), No && (o.style.width = "0px"), Wl(o, "input", function () {
                ...
                ki(n, e) || Q(e, n) || (n.state.pasteIncoming = !0, r.fastPoll())
            }), Wl(o, "cut", t), Wl(o, "copy", t), Wl(e.scroller, "paste", function (t) {
                jt(e, t) || ki(n, t) || (n.state.pasteIncoming = !0, r.focus())
            ...
            var e = this.cm, t = e.display, r = e.doc, n = Ee(e);
            ...
            return Wt(e, function () {
                Z(e, n.slice(o), r.length - o, null, s.composing ? "*compose" : null), n.length > 1e3 || n.indexOf("\n") > -1 ? t.value = s.prevInput = "" : s.prevInput = n, s.composing && (s.composing.range.clear(), s.composing.range = e.markText(s.composing.start, e.getCursor("to"), {className: "CodeMirror-composing"}))
            }), !0
            ...
            function r() {
                if (n.contextMenuPending = !1, n.wrapper.style.cssText = h, l.style.cssText = c, bo && wo < 9 && o.scrollbars.setScrollTop(o.scroller.scrollTop = a), null != l.selectionStart) {
                    (!bo || bo && wo < 9) && t();
                    var e = 0, r = function () {
            ...
            var n = this, i = n.cm, o = i.display, l = n.textarea, s = Xt(i, e), a = o.scroller.scrollTop;
            if (s && !Lo) {
                var u = i.options.resetSelectionOnContextMenu;
                u && i.doc.sel.contains(s) == -1 && At(i, ke)(i.doc, de(s), Il);
                var c = l.style.cssText, h = n.wrapper.style.cssText;
                n.wrapper.style.cssText = "position: absolute";
                var f = n.wrapper.getBoundingClientRect();
                if (l.style.cssText = "position: absolute; width: 30px; height: 30px; top: " + (e.clientY - f.top - 5) + "px; left: " + (e.clientX - f.left - 5) + "px; z-index: 1000; background: " + (bo ? "rgba(255, 255, 255, .05)" : "transparent") + "; outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);", xo)var d = window.scrollY;
                if (o.input.focus(), xo && window.scrollTo(null, d), o.input.reset(), i.somethingSelected() || (l.value = n.prevInput = " "), n.contextMenuPending = !0, o.selForContextMenu = i.doc.sel, clearTimeout(o.detectingSelectAll), bo && wo >= 9 && t(), Po) {
                    Nl(e);
                    var p = function () {
                        Ol(window, "mouseup", p), setTimeout(r, 20)
                    };
                    Wl(window, "mouseup", p)
            ...
            e || this.reset()
        }, setUneditable: Ei, needsContentAttribute: !1
    }, re.prototype), ie.prototype = zi({
        init: function (e) {
            function t(e) {
                if (!ki(n, e)) {
                    if (n.somethingSelected()) Ro = n.getSelections(), "cut" == e.type && n.replaceSelection("", null, "cut"); else {
                        if (!n.options.lineWiseCopyCut)return;
                        var t = ee(n);
            ...
            if (!r || r.bad || !n || n.bad || 0 != Fo($(r, n), t.from()) || 0 != Fo(_(r, n), t.to())) {
                ...
                if (i || o) {
                    var l = this.cm.display.view, s = e.rangeCount && e.getRangeAt(0);
                    if (i) {
                        if (!o) {
                            var a = l[l.length - 1].measure, u = a.maps ? a.maps[a.maps.length - 1] : a.map;
            ...
            if (n.line == t.viewFrom || 0 == (o = Ft(e, n.line)))var l = ti(t.view[0].line),
                s = t.view[0].node; else var l = ti(t.view[o].line), s = t.view[o - 1].node.nextSibling;
            var a = Ft(e, i.line);
            if (a == t.view.length - 1)var u = t.viewTo - 1,
                c = t.lineDiv.lastChild; else var u = ti(t.view[a + 1].line) - 1,
                c = t.view[a + 1].node.previousSibling;
            for (var h = e.doc.splitLines(ue(e, s, c, l, u)), f = Qn(e.doc, zo(l, 0), zo(u, Zn(e.doc, u).text.length)); h.length > 1 && f.length > 1;)if (Di(h) == Di(f)) h.pop(), f.pop(), u--; else {
                if (h[0] != f[0])break;
                h.shift(), f.shift(), l++
            }
            for (var d = 0, p = 0, g = h[0], v = f[0], m = Math.min(g.length, v.length); d < m && g.charCodeAt(d) == v.charCodeAt(d);)++d;
            for (var y = Di(h), b = Di(f), w = Math.min(y.length - (1 == h.length ? d : 0), b.length - (1 == f.length ? d : 0)); p < w && y.charCodeAt(y.length - p - 1) == b.charCodeAt(b.length - p - 1);)++p;
            h[h.length - 1] = y.slice(0, y.length - p), h[0] = h[0].slice(d);
            var x = zo(l, d), C = zo(u, f.length ? Di(f).length - p : 0);
        ...
        }, onContextMenu: Ei, resetPosition: Ei, needsContentAttribute: !0
    }, ie.prototype), e.inputStyles = {textarea: re, contenteditable: ie}, ce.prototype = {
        primary: function () {
    ...
    var Bo, Go, Uo, Vo = {left: 0, right: 0, top: 0, bottom: 0}, Ko = null, jo = 0, Xo = 0, Yo = 0, _o = null;
    ...
    var qo = new Ai, Zo = null, Qo = e.changeEnd = function (e) {
    ...
    e.prototype = {
        constructor: e, focus: function () {
            ...
            this.state.overlays.push({mode: n, modeSpec: t, opaque: r && r.opaque}), this.state.modeGen++, Et(this)
            ...
            for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
                var i = t[n];
                if (i.empty()) i.head.line > r && (Rr(this, i.head.line, e, !0), r = i.head.line, n == this.doc.sel.primIndex && zr(this)); else {
                    var o = i.from(), l = i.to(), s = Math.max(r, o.line);
                    r = Math.min(this.lastLine(), l.line - (l.ch ? 0 : 1)) + 1;
                    for (var a = s; a < r; ++a)Rr(this, a, e);
            ...
            e = ge(this.doc, e);
            var t, r = En(this, Zn(this.doc, e.line)), n = 0, i = (r.length - 1) / 2, o = e.ch;
            ...
            for (var o = 0; o < n._global.length; o++) {
                var s = n._global[o];
                s.pred(i, this) && Hi(r, s.val) == -1 && r.push(s.val)
            }
            return r
            ...
            return e = ht(this, {top: e, left: 0}, t || "page").top, ri(this.doc, e + this.display.viewOffset)
            ...
            return ct(this, r, {top: 0, left: 0}, t || "page").top + (n ? this.doc.height - ni(r) : 0)
        ...
        }, triggerOnKeyDown: Ot(hr), triggerOnKeyPress: Ot(pr), triggerOnKeyUp: dr, execCommand: function (e) {
            if (ul.hasOwnProperty(e))return ul[e].call(null, this)
        }, triggerElectric: Ot(function (e) {
            J(this, e)
        }), findPosH: function (e, t, r, n) {
            var i = 1;
            t < 0 && (i = -1, t = -t);
            for (var o = 0, l = ge(this.doc, e); o < t && (l = Ur(this.doc, l, i, r, n), !l.hitSide); ++o);
            return l
        }, moveH: Ot(function (e, t) {
            var r = this;
            r.extendSelectionsBy(function (n) {
                return r.display.shift || r.doc.extend || n.empty() ? Ur(r.doc, n.head, e, t, r.options.rtlMoveVisually) : e < 0 ? n.from() : n.to()
            }, Fl)
            ...
            if (n.extendSelectionsBy(function (l) {
                ...
                }, Fl), i.length)for (var l = 0; l < n.sel.ranges.length; l++)n.sel.ranges[l].goalColumn = i[l]
        }), findWordAt: function (e) {
            var t = this.doc, r = Zn(t, e.line).text, n = e.ch, i = e.ch;
            if (r) {
            ...
            if (null == e ? (e = {
                    ...
                    to: null
                        ...
                        from: e,
                        to: null
                    }), e.to || (e.to = e.from), e.margin = t || 0, null != e.from.line) Fr(this), this.curOp.scrollToPos = e; else {
    ...
    var Jo = e.defaults = {}, el = e.optionHandlers = {}, tl = e.Init = {
        toString: function () {
    ...
    e.defineMode = function (t, r) {
        ...
        if ("string" == typeof t && nl.hasOwnProperty(t)) t = nl[t]; else if (t && "string" == typeof t.name && nl.hasOwnProperty(t.name)) {
            var r = nl[t.name];
        ...
        var r = e.resolveMode(r), n = rl[r.name];
    ...
    e.registerHelper = function (t, r, n) {
        ll.hasOwnProperty(t) || (ll[t] = e[t] = {_global: []}), ll[t][r] = n
    }, e.registerGlobalHelper = function (t, r, n, i) {
        e.registerHelper(t, r, i), ll[t]._global.push({pred: n, val: i})
    };
        ...
        selectAll: function (e) {
            ...
            Gr(e, function (t) {
                if (t.empty()) {
                    ...
                    } : {from: t.head, to: zo(t.head.line, r)}
                }
                return {from: t.from(), to: t.to()}
            })
        }, deleteLine: function (e) {
            Gr(e, function (t) {
                return {from: zo(t.from().line, 0), to: ge(e.doc, zo(t.to().line + 1, 0))}
            })
        }, delLineLeft: function (e) {
            Gr(e, function (e) {
                return {from: zo(e.from().line, 0), to: e.from()}
            })
            ...
            for (var t = [], r = e.listSelections(), n = e.options.tabSize, i = 0; i < r.length; i++) {
                var o = r[i].from(), l = Rl(e.getLine(o.line), o.ch, n);
            ...
            Wt(e, function () {
                for (var t = e.listSelections(), r = [], n = 0; n < t.length; n++) {
                    var i = t[n].head, o = Zn(e.doc, i.line).text;
                    if (o)if (i.ch == o.length && (i = new zo(i.line, i.ch - 1)), i.ch > 0) i = new zo(i.line, i.ch + 1), e.replaceRange(o.charAt(i.ch - 1) + o.charAt(i.ch - 2), zo(i.line, i.ch - 2), i, "+transpose"); else if (i.line > e.doc.first) {
    ...
    var hl = e.lookupKey = function (e, t, r, n) {
        ...
        return null != n && !e.altGraphKey && (e.altKey && "Alt" != r && (n = "Alt-" + n), (Ho ? e.metaKey : e.ctrlKey) && "Ctrl" != r && (n = "Ctrl-" + n), (Ho ? e.ctrlKey : e.metaKey) && "Cmd" != r && (n = "Cmd-" + n), !t && e.shiftKey && "Shift" != r && (n = "Shift-" + n), n)
    };
    ...
    var gl = 0, vl = e.TextMarker = function (e, t) {
    ...
    Wi(vl), vl.prototype.clear = function () {
        if (!this.explicitlyCleared) {
            ...
            for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
                var l = this.lines[o], s = Jr(l.markedSpans, this);
        ...
        for (var r, n, i = 0; i < this.lines.length; ++i) {
            var o = this.lines[i], l = Jr(o.markedSpans, this);
            if (null != l.from && (r = zo(t ? o : ti(o), l.from), e == -1))return r;
        ...
        if (!this.lines.length && this.doc.cm) {
            ...
            t.maybeHiddenMarkers && Hi(t.maybeHiddenMarkers, this) != -1 || (t.maybeUnhiddenMarkers || (t.maybeUnhiddenMarkers = [])).push(this)
        }
        this.lines.push(e)
    ...
    var gl = 0, ml = e.SharedTextMarker = function (e, t) {
    ...
    Yn.prototype = {
        ...
        chunkSize: function () {
                ...
                if (e <= o) {
                    if (i.insertInner(e, t, r), i.lines && i.lines.length > 50) {
                        for (; i.lines.length > 50;) {
                            var l = i.lines.splice(i.lines.length - 25, 25), s = new Yn(l);
            ...
            if (!(this.children.length <= 10)) {
                var e = this;
                do {
                    var t = e.children.splice(e.children.length - 5, 5), r = new _n(t);
                    if (e.parent) {
    ...
    var Cl = 0, Sl = e.Doc = function (e, t, r, n) {
    ...
    Sl.prototype = Ii(_n.prototype, {
        constructor: Sl, iter: function (e, t, r) {
            ...
            var t = zo(this.first, 0), r = this.first + this.size - 1;
            Tr(this, {
                from: t,
            ...
            return {done: vi(this.history.done), undone: vi(this.history.undone)}
            ...
            e = ge(this, e);
            var t = [], r = Zn(this, e.line).markedSpans;
            ...
            }), n.linked = [{doc: this, isParent: !0, sharedHist: e.sharedHist}], qr(n, $r(this)), n
    ...
    }, Hl = null, Pl = 30, El = e.Pass = {
        toString: function () {
            return "CodeMirror.Pass"
        }
    }, Il = {scroll: !1}, zl = {origin: "*mouse"}, Fl = {origin: "+move"};
    ...
    var _l, $l, ql = e.rmClass = function (e, t) {
        var r = e.className, n = Xi(t).exec(r);
        if (n) {
    ...
    !function () {
        for (var e = 0; e < 10; e++)is[e + 48] = is[e + 96] = String(e);
        for (var e = 65; e <= 90; e++)is[e] = String.fromCharCode(e);
        for (var e = 1; e <= 12; e++)is[e + 111] = is[e + 63235] = "F" + e
    }();
    var os, ls = function () {
        function e(e) {
...
!function (e) {
    ...
    function o(e) {
        ...
        o.style.cssText = "height: 0; overflow: visible", o.className = "CodeMirror-placeholder";
        var t = e.getOption("placeholder");
    ...
    function l(e) {
        var t = e.getWrapperElement(), l = n(e);
        t.className = t.className.replace(" CodeMirror-empty", "") + (l ? " CodeMirror-empty" : ""), l ? o(e) : r(e)
    }
    ...
    e.defineOption("placeholder", "", function (o, n, a) {
        var i = a && a != e.Init;
        if (n && !i) o.on("blur", t), o.on("change", l), l(o); else if (!n && i) {
            o.off("blur", t), o.off("change", l), r(o);
...
!function (t) {
    ...
    function e(t, i, e) {
        ...
        for (var s in p)o[s] = p[s];
        if (n)for (var s in n)void 0 !== n[s] && (o[s] = n[s]);
        if (e)for (var s in e)void 0 !== e[s] && (o[s] = e[s]);
        return o.hint.resolve && (o.hint = o.hint.resolve(t, i)), o
    }
    ...
    function o(t, i) {
        function e(t, e) {
            var o;
            o = "string" != typeof e ? function (t) {
                return e(t, i)
            } : n.hasOwnProperty(e) ? n[e] : e, s[t] = o
        }
        ...
        var n = {
            ...
            }, Enter: i.pick, Tab: i.pick, Esc: i.close
        }, o = t.options.customKeys, s = o ? {} : n;
        if (o)for (var c in o)o.hasOwnProperty(c) && e(c, o[c]);
        var r = t.options.extraKeys;
        if (r)for (var c in r)r.hasOwnProperty(c) && e(c, r[c]);
        return s
    }
    ...
    function c(i, e) {
        ...
        var c = this, r = i.cm, h = this.hints = document.createElement("ul");
        h.className = "CodeMirror-hints", this.selectedHint = e.selectedHint || 0;
        for (var u = e.list, f = 0; f < u.length; ++f) {
            var p = h.appendChild(document.createElement("li")), d = u[f],
                m = l + (f != this.selectedHint ? "" : " " + a);
            null != d.className && (m = d.className + " " + m), p.className = m, d.render ? d.render(p, e, d) : p.appendChild($(d.displayText || n(d))[0]), p.hintId = f
        }
        var g = r.cursorCoords(i.options.alignWithWord ? e.from : null), v = g.left, y = g.bottom, w = !0;
        h.style.left = v + "px", h.style.top = y + "px";
        ...
        (i.options.container || document.body).appendChild(h);
        var C = h.getBoundingClientRect(), b = C.bottom - H;
        if (b > 0) {
            var A = C.bottom - C.top, S = g.top - (g.bottom - C.top);
            if (S - A > 0) h.style.top = (y = g.top - A) + "px", w = !1; else if (A > H) {
                h.style.height = H - 5 + "px", h.style.top = (y = g.bottom - C.top) + "px";
                var x = r.getCursor();
                e.from.ch != x.ch && (g = r.cursorCoords(x), h.style.left = (v = g.left) + "px", C = h.getBoundingClientRect())
            }
        }
        var T = C.right - k;
        if (T > 0 && (C.right - C.left > k && (h.style.width = k - 5 + "px", T -= C.right - C.left - k), h.style.left = (v = g.left - T) + "px"), r.addKeyMap(this.keyMap = o(i, {
                moveFocus: function (t, i) {
                    c.changeActive(c.selectedHint + t, i)
                }, setFocus: function (t) {
                    c.changeActive(t)
                }, menuSize: function () {
                    return c.screenAmount()
                }, length: u.length, close: function () {
                    i.close()
                }, pick: function () {
                    c.pick()
                }, data: e
            ...
            var M;
            r.on("blur", this.onBlur = function () {
        ...
        var F = r.getScrollInfo();
        return r.on("scroll", this.onScroll = function () {
            var t = r.getScrollInfo(), e = r.getWrapperElement().getBoundingClientRect(), n = y + F.top - t.top,
                o = n - (window.pageYOffset || (document.documentElement || document.body).scrollTop);
            return w || (o += h.offsetHeight), o <= e.top || o >= e.bottom ? i.close() : (h.style.top = n + "px", void(h.style.left = v + F.left - t.left + "px"))
        }), t.on(h, "dblclick", function (t) {
            var i = s(h, t.target || t.srcElement);
            i && null != i.hintId && (c.changeActive(i.hintId), c.pick())
        }), t.on(h, "click", function (t) {
            var e = s(h, t.target || t.srcElement);
            e && null != e.hintId && (c.changeActive(e.hintId), i.options.completeOnSingleClick && c.pick())
        }), t.on(h, "mousedown", function () {
            setTimeout(function () {
                r.focus()
            }, 20)
        }), t.signal(e, "select", u[0], h.firstChild), !0
    }
    ...
    function h(i, e) {
        ...
        if (o.length) {
            for (var s, c = !1, h = 0; h < o.length; h++)o[h].async && (c = !0);
            return c ? (s = function (t, i, e) {
                function n(o, c) {
                    if (o == s.length)return i(null);
                    var r = s[o];
                    if (r.async) r(t, function (t) {
                        t ? i(t) : n(o + 1)
                    }, e); else {
                        var c = r(t, e);
                        c ? i(c) : n(o + 1)
                ...
                var s = r(t, o);
                n(0)
            }, s.async = !0) : s = function (t, i) {
                for (var e = r(t, o), n = 0; n < e.length; n++) {
                    var s = e[n](t, i);
                    if (s && s.list.length)return s
                }
            }, s.supportsSelection = !0, s
        }
        return (n = i.getHelper(i.getCursor(), "hintWords")) ? function (i) {
            return t.hint.fromList(i, {words: n})
    ...
    var l = "CodeMirror-hint", a = "CodeMirror-hint-active";
    t.showHint = function (t, i, e) {
        ...
        n = e(this, this.getCursor("start"), n);
        var o = this.listSelections();
        if (!(o.length > 1)) {
            if (this.somethingSelected()) {
                if (!n.hint.supportsSelection)return;
                for (var s = 0; s < o.length; s++)if (o[s].head.line != o[s].anchor.line)return
            }
            this.state.completionActive && this.state.completionActive.close();
            var c = this.state.completionActive = new i(this, n);
            c.options.hint && (t.signal(this, "startCompletion", this), c.update(!0))
        }
    });
    ...
    i.prototype = {
        close: function () {
            ...
            var o = i.list[e];
            o.hint ? o.hint(this.cm, i, o) : this.cm.replaceRange(n(o), o.from || i.from, o.to || i.to, "complete"), t.signal(i, "pick", o), this.close()
        }, cursorActivity: function () {
            this.debounce && (f(this.debounce), this.debounce = 0);
            var t = this.cm.getCursor(), i = this.cm.getLine(t.line);
            if (t.line != this.startPos.line || i.length - t.ch != this.startLen - this.startPos.ch || t.ch < this.startPos.ch || this.cm.somethingSelected() || t.ch && this.options.closeCharacters.test(i.charAt(t.ch - 1))) this.close(); else {
                var e = this;
                this.debounce = u(function () {
                    e.update()
                }), this.widget && this.widget.disable()
            }
        }, update: function (t) {
            if (null != this.tick)if (this.options.hint.async) {
                var i = ++this.tick, e = this;
                this.options.hint(this.cm, function (n) {
                    e.tick == i && e.finishUpdate(n, t)
                }, this.options)
            } else this.finishUpdate(this.options.hint(this.cm, this.options), t)
        }, finishUpdate: function (i, e) {
            this.data && t.signal(this.data, "update"), i && this.data && t.cmpPos(i.from, this.data.from) && (i = null), this.data = i;
            var n = this.widget && this.widget.picked || e && this.options.completeSingle;
            this.widget && this.widget.close(), i && i.list.length && (n && 1 == i.list.length ? this.pick(i, 0) : (this.widget = new c(this, i), t.signal(i, "shown")))
        }
    }, c.prototype = {
        close: function () {
        ...
        }, changeActive: function (i, e) {
            if (i >= this.data.list.length ? i = e ? this.data.list.length - 1 : 0 : i < 0 && (i = e ? 0 : this.data.list.length - 1), this.selectedHint != i) {
                var n = this.hints.childNodes[this.selectedHint];
                n.className = n.className.replace(" " + a, ""), n = this.hints.childNodes[this.selectedHint = i], n.className += " " + a, n.offsetTop < this.hints.scrollTop ? this.hints.scrollTop = n.offsetTop - 3 : n.offsetTop + n.offsetHeight > this.hints.scrollTop + this.hints.clientHeight && (this.hints.scrollTop = n.offsetTop + n.offsetHeight - this.hints.clientHeight + 3), t.signal(this.data, "select", this.data.list[this.selectedHint], n)
            }
        }, screenAmount: function () {
            return Math.floor(this.hints.clientHeight / this.hints.firstChild.offsetHeight) || 1
        }
    }, t.registerHelper("hint", "auto", {resolve: h}), t.registerHelper("hint", "fromList", function (i, e) {
        var n = i.getCursor(), o = i.getTokenAt(n), s = t.Pos(n.line, o.end);
        if (o.string && /\w/.test(o.string[o.string.length - 1]))var c = o.string,
            r = t.Pos(n.line, o.start); else var c = "", r = s;
        for (var h = [], l = 0; l < e.words.length; l++) {
            var a = e.words[l];
            a.slice(0, c.length) == c && h.push(a)
        }
        if (h.length)return {list: h, from: r, to: s}
...
!function (e) {
    function t(e) {
        return e = S ? e.replace("Ctrl", "Cmd") : e.replace("Cmd", "Ctrl")
    }

    function n(e) {
        if ("image" === e.name)return $(e.html)[0];
        var t = {
        ...
        }, n = document.createElement("a"), r = t[e.name];
        return S && (r = r.replace("ctrl", "⌘").replace("shift", "⇧")), n.className = "tooltipped tooltipped-n", n.setAttribute("aria-label", r), n.innerHTML = "<span class='icon-" + e.name + "'></span>", n
    }
    ...
    function i(e, t) {
        ...
        if (!n.type)return {};
        for (var r, i, o = n.type.split(" "), a = {}, l = 0; l < o.length; l++)r = o[l], "strong" === r ? a.bold = !0 : "variable-2" === r ? (i = e.getLine(t.line), /^\s*\d+\.\s/.test(i) ? a["ordered-list"] = !0 : a["unordered-list"] = !0) : "atom" === r ? a.quote = !0 : "em" === r && (a.italic = !0);
        return a
    }

    function o(e) {
        var t = e.codemirror, n = e.codemirror.getWrapperElement();
        if ("icon-fullscreen" === e.toolbar.fullscreen.children[0].className)return e.toolbar.fullscreen.children[0].className = "icon-contract", e.toolbar.preview.style.display = "none", e.toolbar.preview.className.indexOf("active") > -1 && e.toolbar.preview.click(), $(e.element.parentElement).css({
            position: "fixed",
            top: "0",
            "z-index": "90",
            left: "0",
            right: "0"
        }), t.state.fullScreenRestore = {
            scrollTop: window.pageYOffset,
            scrollLeft: window.pageXOffset,
            width: n.style.width,
            height: n.style.height
        }, n.style.width = "50%", n.style.height = $(window).height() - $(".editor-toolbar").outerHeight() + "px", t.refresh(), $.ajax({
            url: e.options.htmlURL,
            type: "POST",
            cache: !1,
            data: {markdownText: t.getValue()},
            success: function (t, n) {
                $(e.element.parentElement).prepend('<div class="CodeMirror-preview content-reset" style="height:' + ($(window).height() - $(".editor-toolbar").outerHeight()) + 'px">' + t.html + "</div>"), hljs.initHighlighting.called = !1, hljs.initHighlighting()
            }
        }), !1;
        e.toolbar.fullscreen.children[0].className = "icon-fullscreen", e.toolbar.preview.style.display = "inline", $(e.element.parentElement).css({position: "inherit"}), $(e.element.parentElement).find(".CodeMirror-preview").remove();
        var r = t.state.fullScreenRestore;
        n.style.width = r.width, n.style.height = r.height, t.refresh()
    }

    function a(e) {
        var t, n = e.codemirror, r = i(n), o = "**", a = "**", l = n.getCursor("start"), s = n.getCursor("end");
        r.bold ? (t = n.getLine(l.line), o = t.slice(0, l.ch), a = t.slice(l.ch), o = o.replace(/^(.*)?(\*|\_){2}(\S+.*)?$/, "$1$3"), a = a.replace(/^(.*\S+)?(\*|\_){2}(\s+.*)?$/, "$1$3"), l.ch -= 2, s.ch -= 2, n.replaceRange(o + a, CodeMirror.Pos(l.line, 0), CodeMirror.Pos(l.line, t.length))) : (t = n.getSelection(), n.replaceSelection(o + t + a), l.ch += 2, s.ch += 2), n.setSelection(l, s), n.focus()
    }

    function l(e) {
        var t, n = e.codemirror, r = i(n), o = "*", a = "*", l = n.getCursor("start"), s = n.getCursor("end");
        r.italic ? (t = n.getLine(l.line), o = t.slice(0, l.ch), a = t.slice(l.ch), o = o.replace(/^(.*)?(\*|\_)(\S+.*)?$/, "$1$3"), a = a.replace(/^(.*\S+)?(\*|\_)(\s+.*)?$/, "$1$3"), l.ch -= 1, s.ch -= 1, n.replaceRange(o + a, CodeMirror.Pos(l.line, 0), CodeMirror.Pos(l.line, t.length))) : (t = n.getSelection(), n.replaceSelection(o + t + a), l.ch += 1, s.ch += 1), n.setSelection(l, s), n.focus()
    }
    ...
    function h(e) {
        var t = e.toolbar.preview, n = e.codemirror, r = n.getWrapperElement(), i = r.lastChild;
        /editor-preview/.test(i.className) || (i = document.createElement("div"), i.className = "editor-preview content-reset", r.appendChild(i)), /editor-preview-active/.test(i.className) ? (i.className = i.className.replace(/\s*editor-preview-active\s*/g, ""), t.className = t.className.replace(/\s*active\s*/g, "")) : (setTimeout(function () {
            i.className += " editor-preview-active"
        }, 1), t.className += " active");
        var o = n.getValue();
        $.ajax({
            url: e.options.htmlURL, type: "POST", cache: !1, data: {markdownText: o}, success: function (e, t) {
                i.innerHTML = e.html, hljs.initHighlighting.called = !1, hljs.initHighlighting()
            }
        })
    }

    function g(e, t, n, r) {
        var i, o = e.getCursor("start"), a = e.getCursor("end");
        t ? (i = e.getLine(o.line), n = i.slice(0, o.ch), r = i.slice(o.ch), e.replaceRange(n + r, CodeMirror.Pos(o.line, 0), CodeMirror.Pos(o.line, i.length))) : (i = e.getSelection(), e.replaceSelection(n + i + r), o.ch += n.length, a.ch += n.length), e.setSelection(o, a), e.focus()
    }

    function v(e, t) {
        for (var n = i(e), r = e.getCursor("start"), o = e.getCursor("end"), a = {
            quote: /^(\s*)\>\s+/,
            "unordered-list": /^(\s*)(\*|\-|\+)\s+/,
            "ordered-list": /^(\s*)\d+\.\s+/
        }, l = {
            ...
            "unordered-list": "* ",
            "ordered-list": "1. "
        }, s = r.line; s <= o.line; s++)!function (r) {
            var i = e.getLine(r);
            i = n[t] ? i.replace(a[t], "$1") : l[t] + i, e.replaceRange(i, CodeMirror.Pos(r, 0), CodeMirror.Pos(r, e.getLine(r).length))
        }(s);
        e.focus()
    }
    ...
    var C = /^(\s*)([*+-]|(\d+)\.)([\w+(\s+\w+)]|[\s*])/, x = /^(\s*)([*+-]|(\d+)\.)(\s*)$/, L = "*+-",
        w = function (e, t) {
            return e.getStateAfter(t.line).list || null
        }, M = function (e) {
            var t = e.getCursor();
            return w(e, t)
        };
    CodeMirror.commands.shiftTabAndIndentContinueMarkdownList = function (e) {
        var t = M(e);
        return null !== t ? void e.execCommand("insertTab") : void e.execCommand("indentLess")
    }, CodeMirror.commands.tabAndIndentContinueMarkdownList = function (e) {
        var t = M(e);
        return null !== t ? void e.execCommand("insertTab") : void e.execCommand("indentMore")
    }, CodeMirror.commands.newlineAndIndentContinueMarkdownList = function (e) {
        var t, n, r, i, o;
        if (t = e.getCursor(), n = e.getTokenAt(t), i = e.getLine(t.line).match(x), o = w(e, t), !o && i)return e.replaceRange("", {
            line: t.line,
            ch: n.start
        }, {line: t.line, ch: n.end}), e.execCommand("delLineLeft"), void e.execCommand("newlineAndIndent");
        if (!o || !(r = e.getLine(t.line).match(C)))return void e.execCommand("newlineAndIndent");
        var a = r[1], l = " ", s = L.indexOf(r[2]) >= 0 ? r[2] : parseInt(r[3], 10) + 1 + ".";
        e.replaceSelection("\n" + a + s + l, "end")
        ...
        function n(e, t) {
            ...
            if ("<" == i) {
                ...
                return b ? (C = l ? "closeTag" : "openTag", t.tokenize = r, "tag") : "error"
            }
            if ("&" == i) {
                var c;
        ...
        function r(e, t) {
            var r = e.next();
            return ">" == r || "/" == r && e.eat(">") ? (t.tokenize = n, C = ">" == r ? "endTag" : "selfcloseTag", "tag") : "=" == r ? (C = "equals", null) : "<" == r ? "error" : /[\'\"]/.test(r) ? (t.tokenize = i(r), t.stringStartCol = e.column(), t.tokenize(e, t)) : (e.eatWhile(/[^\s\u00a0=<>\"\']/), "word")
        }
        ...
        function c(e, t) {
            var n = T.doNotIndent.hasOwnProperty(e) || x.context && x.context.noIndent;
            x.context = {prev: x.context, tagName: e, indent: x.indented, startOfLine: t, noIndent: n}
        }
        ...
        function u(e) {
            if ("openTag" == e)return x.tagName = b, x.tagStart = L.column(), s(h, f(x.startOfLine));
            if ("closeTag" == e) {
                var t = !1;
                return x.context ? x.context.tagName != b && (T.implicitlyClosed.hasOwnProperty(x.context.tagName.toLowerCase()) && d(), t = !x.context || x.context.tagName != b) : t = !0, t && (w = "error"), s(m(t))
            }
            return s()
        }
        ...
        function f(e) {
            return function (t) {
                var n = x.tagName;
                return x.tagName = x.tagStart = null, "selfcloseTag" == t || "endTag" == t && T.autoSelfClosers.hasOwnProperty(n.toLowerCase()) ? (p(n.toLowerCase()), s()) : "endTag" == t ? (p(n.toLowerCase()), c(n, e), s()) : s()
            }
        }

        function m(e) {
            return function (t) {
                return e && (w = "error"), "endTag" == t ? (d(), s()) : (w = "error", s(arguments.callee))
            }
        }
        ...
        function p(e) {
            for (var t; ;) {
                if (!x.context)return;
                if (t = x.context.tagName.toLowerCase(), !T.contextGrabbers.hasOwnProperty(t) || !T.contextGrabbers[t].hasOwnProperty(e))return;
                d()
            }
        }

        function h(e) {
            return "word" == e ? (w = "attribute", s(g, h)) : "endTag" == e || "selfcloseTag" == e ? l() : (w = "error", s(h))
        }

        function g(e) {
            return "equals" == e ? s(v, h) : (T.allowMissing ? "word" == e && (w = "attribute") : w = "error", "endTag" == e || "selfcloseTag" == e ? l() : s())
        }

        function v(e) {
            return "string" == e ? s(k) : "word" == e && T.allowUnquoted ? (w = "string", s()) : (w = "error", "endTag" == e || "selfCloseTag" == e ? l() : s())
        }

        function k(e) {
            return "string" == e ? s(k) : l()
        }

        var b, C, x, L, w, M = e.indentUnit, S = t.multilineTagIndentFactor || 1, y = t.multilineTagIndentPastTag || !0,
            T = t.htmlMode ? {
                autoSelfClosers: {
                    area: !0,
                    base: !0,
        ...
        return {
            startState: function () {
                return {tokenize: n, cc: [], indented: 0, startOfLine: !0, tagName: null, tagStart: null, context: null}
            },
            token: function (e, t) {
                if (!t.tagName && e.sol() && (t.startOfLine = !0, t.indented = e.indentation()), e.eatSpace())return null;
                w = C = b = null;
                var n = t.tokenize(e, t);
                if (t.type = C, (n || C) && "comment" != n)for (x = t, L = e; ;) {
                    var r = t.cc.pop() || u;
                    if (r(C || n))break
                }
                return t.startOfLine = !1, w || n
            },
            indent: function (e, t, i) {
                var o = e.context;
                if (e.tokenize.isInAttribute)return e.stringStartCol + 1;
                if (e.tokenize != r && e.tokenize != n || o && o.noIndent)return i ? i.match(/^(\s*)/)[0].length : 0;
                if (e.tagName)return y ? e.tagStart + e.tagName.length + 2 : e.tagStart + M * S;
                if (N && /<!\[CDATA\[/.test(t))return 0;
                for (o && /^<\//.test(t) && (o = o.prev); o && !o.startOfLine;)o = o.prev;
                return o ? o.indent + M : 0
            },
            electricChars: "/",
            blockCommentStart: "<!--",
            blockCommentEnd: "-->",
        ...
        function i(e) {
            return e.linkTitle = !1, e.em = !1, e.strong = !1, e.strike = !1, e.quote = 0, g || e.f != a || (e.f = d, e.block = o), e.trailingSpace = 0, e.trailingSpaceNewLine = !1, e.thisLineHasContent = !1, null
        }

        function o(e, i) {
            var o = i.list !== !1;
            if (i.list !== !1 && i.indentationDiff >= 0 ? (i.indentationDiff < 4 && (i.indentation -= i.indentationDiff), i.list = null) : i.list !== !1 && i.indentation > 0 ? (i.list = null, i.listDepth = Math.floor(i.indentation / 4)) : i.list !== !1 && (i.list = !1, i.listDepth = 0), i.indentationDiff >= 4)return i.indentation -= 4, e.skipToEnd(), L;
            if (e.eatSpace())return null;
            if ("#" === e.peek() || i.prevLineHasContent && e.match(B)) i.header = !0; else if (e.eat(">"))for (i.indentation++, i.quote = 1, e.eatSpace(); e.eat(">");)e.eatSpace(), i.quote++; else {
                if ("[" === e.peek())return n(e, i, f);
                if (e.match(z, !0))return N;
                if (i.prevLineHasContent && !o || !e.match(P, !0) && !e.match(D, !0)) {
                    if (t.fencedCodeBlocks && e.match(/^```([\w+#]*)/, !0))return i.localMode = b(RegExp.$1), i.localMode && (i.localState = i.localMode.startState()), r(e, i, l), L
                } else i.indentation += 4, i.list = !0, i.listDepth++, t.taskLists && e.match(W, !1) && (i.taskList = !0)
            }
        ...
        function a(e, t) {
            ...
            return g && "tag" === n && "openTag" !== t.htmlState.type && !t.htmlState.context && (t.f = d, t.block = o), t.md_inside && e.current().indexOf(">") != -1 && (t.f = d, t.block = o, t.htmlState.context = void 0), n
        }

        function l(e, t) {
            return e.sol() && e.match(/^```/, !0) ? (t.localMode = t.localState = null, t.f = d, t.block = o, L) : t.localMode ? t.localMode.token(e, t.localState) : (e.skipToEnd(), L)
        }
        ...
        function s(e) {
            ...
            if (e.strong && t.push(q), e.strike && t.push(_), e.em && t.push(H), e.linkText && t.push(I), e.code && t.push(L), e.header && t.push(x), e.quote && t.push(e.quote % 2 ? w : M), e.list !== !1) {
                var n = (e.listDepth - 1) % 3;
                n ? 1 === n ? t.push(y) : t.push(T) : t.push(S)
            }
        ...
        function d(e, i) {
            ...
            if (i.taskList) {
                var l = "x" !== e.match(W, !0)[1];
                return l ? i.taskOpen = !0 : i.taskClosed = !0, i.taskList = !1, s(i)
            }
            i.taskOpen = !1, i.taskClosed = !1;
            var c = e.next();
            if ("\\" === c)return e.next(), s(i);
            if (i.linkTitle) {
                i.linkTitle = !1;
                var d = c;
                "(" === c && (d = ")"), d = (d + "").replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1");
                var f = "^\\s*(?:[^" + d + "\\\\]+|\\\\\\\\|\\\\.)" + d;
                if (e.match(new RegExp(f), !0))return A
            }
            if ("`" === c) {
                var m = s(i), p = e.pos;
                e.eatWhile("`");
                var g = 1 + e.pos - p;
                return i.code ? g === C ? (i.code = !1, m) : s(i) : (C = g, i.code = !0, s(i))
            }
            if (i.code)return s(i);
            if ("!" === c && e.match(/\[[^\]]*\] ?(?:\(|\[)/, !1))return e.match(/\[[^\]]*\]/), i.inline = i.f = u, $;
            if ("[" === c && e.match(/.*\](\(| ?\[)/, !1))return i.linkText = !0, s(i);
            if ("]" === c && i.linkText) {
                var v = s(i);
                return i.linkText = !1, i.inline = i.f = u, v
            }
            if ("<" === c && e.match(/^(https?|ftps?):\/\/(?:[^\\>]|\\.)+>/, !1))return n(e, i, h(E, ">"));
            if ("<" === c && e.match(/^[^> \\]+@(?:[^\\>]|\\.)+>/, !1))return n(e, i, h(O, ">"));
            if ("<" === c && e.match(/^\w/, !1)) {
                if (e.string.indexOf(">") != -1) {
                    var k = e.string.substring(1, e.string.indexOf(">"));
                    /markdown\s*=\s*('|"){0,1}1('|"){0,1}/.test(k) && (i.md_inside = !0)
                }
                return e.backUp(1), r(e, i, a)
            }
            if ("<" === c && e.match(/^\/\w*?>/))return i.md_inside = !1, "tag";
            var b = !1;
            if (!t.underscoresBreakWords && "_" === c && "_" !== e.peek() && e.match(/(\w)/, !1)) {
                var x = e.pos - 2;
                if (x >= 0) {
                    var L = e.string.charAt(x);
                    "_" !== L && L.match(/(\w)/, !1) && (b = !0)
                }
            }
            var m = s(i);
            if ("*" === c || "_" === c && !b) {
                if (i.strong === c && e.eat(c) && e.peek(c))return i.strong = !1, m;
                if (!i.strong && e.eat(c) && e.peek(c))return i.strong = c, s(i);
                if (i.em === c)return i.em = !1, m;
                if (!i.em)return i.em = c, s(i)
            } else if ("~" === c) {
                if (i.strike === c && e.eat(c))return i.strike = !1, m;
                if (!i.strike && e.eat(c))return i.strike = c, s(i)
            } else if (" " === c && (e.eat("*") || e.eat("_"))) {
                if (" " === e.peek())return s(i);
                e.backUp(1)
            }
            return " " === c && (e.match(/ +$/, !1) ? i.trailingSpace++ : i.trailingSpace && (i.trailingSpaceNewLine = !0)), s(i)
        }

        function u(e, t) {
            if (e.eatSpace())return null;
            var r = e.next();
            return "(" === r || "[" === r ? n(e, t, h(A, "(" === r ? ")" : "]")) : "error"
        }

        function f(e, t) {
            return e.match(/^[^\]]*\]:/, !0) ? (t.f = m, I) : n(e, t, d)
        }

        function m(e, t) {
            return e.eatSpace() ? null : (e.match(/^[^\s]+/, !0), void 0 === e.peek() ? t.linkTitle = !0 : e.match(/^(?:\s+(?:"(?:[^"\\]|\\\\|\\.)+"|'(?:[^'\\]|\\\\|\\.)+'|\((?:[^)\\]|\\\\|\\.)+\)))?/, !0), t.f = t.inline = d, A)
        }

        function p(e) {
            return R[e] || (e = (e + "").replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1"), R[e] = new RegExp("^(?:[^\\\\]|\\\\.)*?(" + e + ")")), R[e]
        }

        function h(e, t, n) {
            return n = n || d, function (r, i) {
                return r.match(p(t)), i.inline = i.f = n, e
            }
        }

        var g = CodeMirror.modes.hasOwnProperty("xml"),
            v = CodeMirror.getMode(e, g ? {name: "xml", htmlMode: !0} : "text/plain"), k = {
                html: "htmlmixed",
                js: "javascript",
                ...
                for (var s in k)(k[s] in r || k[s] in i) && (r[s] = k[s]);
                return function (t) {
        ...
        var C = 0, x = "header", L = "comment", w = "atom", M = "number", S = "variable-2", y = "variable-3",
            T = "keyword", N = "hr", $ = "tag", E = "link", O = "link", I = "link", A = "string", H = "em",
            q = "strong", _ = "strike", z = /^([*\-=_])(?:\s*\1){4,}\s*$/, P = /^[*\-+]\s+/, D = /^[0-9]+\.\s+/,
            W = /^\[(x| )\](?=\s)/, B = /^(?:\={1,}|-{1,})$/, j = /^[^!\[\]*_~\\<>` "'(]+/, R = [];
        return {
            startState: function () {
                return {
                ...
                return t.f(e, t)
            }, blankLine: i, getType: s
        }
    }, "xml"), CodeMirror.defineMIME("text/x-markdown", "markdown");
    var S = /Mac/.test(navigator.platform), y = {
        "Cmd-B": a,
        "Cmd-I": l,
        "Cmd-K": u,
        "Cmd-E": s,
        ...
        "Cmd-D": h,
        "Shift-Cmd-A": o
    }, T = [{name: "bold", action: a}, {name: "italic", action: l}, "|", {
        name: "quote",
        action: s
    }, {name: "unordered-list", action: c}, {name: "ordered-list", action: d}, "|", {
        name: "link",
        action: u
    }, {name: "image", action: f}, "|", {name: "redo", action: p}, {name: "undo", action: m}, "|", {
        name: "preview",
        action: h
    }, {name: "fullscreen", action: o}];
    b.toolbar = T, b.markdown = function (e) {
        if (window.marked)return marked(e)
        ...
        if (e || (e = this.element || document.getElementsByTagName("textarea")[0]), !this._rendered || this._rendered !== e) {
            this.element = e;
            var n = this.options, r = this, i = {};
            for (var o in y)!function (e) {
                i[t(e)] = function (t) {
                    y[e](r)
                }
            }(o);
            i.Enter = "newlineAndIndentContinueMarkdownList", i.Tab = "tabAndIndentContinueMarkdownList", i["Shift-Tab"] = "shiftTabAndIndentContinueMarkdownList", $.extend(i, n.extraKeys), this.codemirror = CodeMirror.fromTextArea(e, {
                mode: "markdown",
                indentWithTabs: !0,
                lineNumbers: !1,
                ...
                extraKeys: i,
                inputStyle: "textarea"
            }), n.toolbar !== !1 && this.createToolbar(), n.status !== !1 && this.createStatusbar(), this._rendered = this.element
        }
        ...
        if (e = e || this.options.toolbar, e && 0 !== e.length) {
            ...
            for (var a = 0; a < e.length; a++)!function (e) {
                var i;
                if (i = "|" === e ? r() : n(e), !e.action)for (var a = 0, l = b.toolbar.length; a < l; a++)if (b.toolbar[a].name === e.name) {
                    e.action = b.toolbar[a].action;
                    break
                }
                e.action && ("function" == typeof e.action && "image" !== e.name ? i.onclick = function (t) {
                    e.action(o)
            ...
            l.on("cursorActivity", function () {
                ...
                for (var t in o.toolbar)!function (t) {
                    var n = o.toolbar[t];
                    e[t] ? n.className.indexOf("active") === -1 && (n.className += " active") : n.className = n.className.replace(/\s*active\s*/g, "")
                }(t)
            });
        ...
        if (e = e || this.options.status, e && 0 !== e.length) {
            ...
            for (var n, r = this.codemirror, i = 0; i < e.length; i++)!function (e) {
                var i = document.createElement("span");
                i.className = e, "words" === e ? (i.innerHTML = "0", r.on("update", function () {
                    i.innerHTML = k(r.getValue())
                })) : "lines" === e ? (i.innerHTML = "0", r.on("update", function () {
                    i.innerHTML = r.lineCount()
                })) : "cursor" === e && (i.innerHTML = "0:0", r.on("cursorActivity", function () {
                        n = r.getCursor(), i.innerHTML = n.line + ":" + n.ch
                    })), t.appendChild(i)
            }(e[i]);
        ...
        return e ? (this.codemirror.getDoc().setValue(e), this) : this.codemirror.getValue()
    }, b.toggleBold = a, b.toggleItalic = l, b.toggleBlockquote = s, b.toggleUnOrderedList = c, b.toggleOrderedList = d, b.drawLink = u, b.drawImage = f, b.undo = m, b.redo = p, b.togglePreview = h, b.toggleFullScreen = o, b.prototype.toggleBold = function () {
        a(this)
...
!function (e) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = e(); else if ("function" == typeof define && define.amd) define([], e); else {
        var n;
        n = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, n.toMarkdown = e()
    }
}(function () {
    return function e(n, t, r) {
        ...
        1: [function (e, n, t) {
            ...
            function i(e) {
                ...
                return N(n.documentElement, r), n
            }

            function a(e) {
                for (var n, t, r, o = [e], i = []; o.length > 0;)for (n = o.shift(), i.push(n), t = n.childNodes, r = 0; r < t.length; r++)1 === t[r].nodeType && o.push(t[r]);
                return i.shift(), i
            }

            function c(e) {
                for (var n = "", t = 0; t < e.childNodes.length; t++)if (1 === e.childNodes[t].nodeType) n += e.childNodes[t]._replacement; else {
                    if (3 !== e.childNodes[t].nodeType)continue;
            ...
            function u(e, n) {
                if ("string" == typeof n)return n === e.nodeName.toLowerCase();
                if (Array.isArray(n))return n.indexOf(e.nodeName.toLowerCase()) !== -1;
                if ("function" == typeof n)return n.call(p, e);
                throw new TypeError("`filter` needs to be a string, array, or function")
            }

            function f(e, n) {
                var t, o, i;
                return "left" === e ? (t = n.previousSibling, o = / $/) : (t = n.nextSibling, o = /^ /), t && (3 === t.nodeType ? i = o.test(t.nodeValue) : 1 !== t.nodeType || r(t) || (i = o.test(t.textContent))), i
            }
            ...
            function s(e) {
                ...
                for (var r = 0; r < m.length; r++) {
                    ...
                    if (u(e, i.filter)) {
                        ...
                        var a = d(e);
                        (a.leading || a.trailing) && (t = t.trim()), n = a.leading + i.replacement.call(p, t, e) + a.trailing;
                        break
                    }
                }
                e._replacement = n
            ...
            var p, m, h = e("./lib/md-converters"), g = e("./lib/gfm-converters"), v = e("./lib/html-parser"),
                N = e("collapse-whitespace"),
                ...
                y = ["area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"];
            p = function (e, n) {
                if (n = n || {}, "string" != typeof e)throw new TypeError(e + " is not a string");
                e = e.replace(/(\d+)\. /g, "$1\\. ");
                var t, r = i(e).body, o = a(r);
                m = h.slice(0), n.gfm && (m = g.concat(m)), n.converters && (m = n.converters.concat(m));
                for (var l = o.length - 1; l >= 0; l--)s(o[l]);
                return t = c(r), t.replace(/^[\t\r\n]+|[\t\r\n\s]+$/g, "").replace(/\n\s+\n/g, "\n\n").replace(/\n{3,}/g, "\n\n")
            }, p.isBlock = r, p.isVoid = o, p.outer = l, n.exports = p
        }, {"./lib/gfm-converters": 2, "./lib/html-parser": 3, "./lib/md-converters": 4, "collapse-whitespace": 7}],
        2: [function (e, n, t) {
            "use strict";
            function r(e, n) {
                var t = Array.prototype.indexOf.call(n.parentNode.childNodes, n), r = " ";
                return 0 === t && (r = "| "), r + e + " |"
            }
            ...
            n.exports = [{
                ...
                filter: ["th", "td"], replacement: function (e, n) {
                    return r(e, n)
                }
            }, {
                filter: "tr", replacement: function (e, n) {
                    var t = "", o = {left: ":--", right: "--:", center: ":-:"};
                    if ("THEAD" === n.parentNode.nodeName)for (var i = 0; i < n.childNodes.length; i++) {
                        var a = n.childNodes[i].attributes.align, c = "---";
                        a && (c = o[a.value] || c), t += r(c, n.childNodes[i])
                    }
                    return "\n" + e + (t ? "\n" + t : "")
                }
            }, {
            ...
            function o() {
                ...
                if ("undefined" == typeof document) {
                    ...
                    n.prototype.parseFromString = function (e) {
                        return t.jsdom(e, {features: {FetchExternalResources: [], ProcessExternalResources: !1}})
                    }
                } else i() ? n.prototype.parseFromString = function (e) {
        ...
        4: [function (e, n, t) {
            ...
            n.exports = [{
                ...
                filter: ["h1", "h2", "h3", "h4", "h5", "h6"], replacement: function (e, n) {
                    for (var t = n.nodeName.charAt(1), r = "", o = 0; o < t; o++)r += "#";
                    return "\n\n" + r + " " + e + "\n\n"
                }
            }, {
                ...
                filter: "img", replacement: function (e, n) {
                    var t = n.alt || "", r = n.getAttribute("src") || "", o = n.title || "",
                        i = o ? ' "' + o + '"' : "";
                    return r ? "![" + t + "](" + r + i + ")" : ""
                }
            }, {
                ...
                filter: "li", replacement: function (e, n) {
                    e = e.replace(/^\s+/, "").replace(/\n/gm, "\n    ");
                    var t = "*   ", r = n.parentNode, o = Array.prototype.indexOf.call(r.children, n) + 1;
                    return t = /ol/i.test(r.nodeName) ? o + ".  " : "*   ", t + e
                }
            }, {
                filter: ["ul", "ol"], replacement: function (e, n) {
                    for (var t = [], r = 0; r < n.childNodes.length; r++)t.push(n.childNodes[r]._replacement);
                ...
                if (e.firstChild && "PRE" !== e.nodeName) {
                    ...
                    for (var t = null, i = !1, l = null, u = c(l, e); u !== e;) {
                        if (3 === u.nodeType) {
                            ...
                            if (t && !/ $/.test(t.data) || i || " " !== f[0] || (f = f.substr(1)), !f) {
                                u = a(u);
                                continue
                            }
                            u.data = f, t = u
                            ...
                            n(u) || "BR" === u.nodeName ? (t && (t.data = t.data.replace(/ $/, "")), t = null, i = !1) : o(u) && (t = null, i = !0)
                        }
                        var d = c(l, u);
                        l = u, u = d
                    }
                    t && (t.data = t.data.replace(/ $/, ""), t.data || a(t))
                }
            }
...
!function (e) {
    ...
    function i(e) {
        ...
        for (s = s.split(/\s+/), t = 0, n = s.length; n > t; t++)if (i = s[t], a(i) || y(i))return i
    }
    ...
    function c(e) {
        ...
        return function e(n, a) {
            for (var i = n.firstChild; i; i = i.nextSibling)3 === i.nodeType ? a += i.nodeValue.length : 1 === i.nodeType && (t.push({
                    ...
                    offset: a,
                    node: i
                }), a = e(i, a), r(i).match(/br|hr|img|input/) || t.push({event: "stop", offset: a, node: i}));
            return a
        }(e, 0), t
    }
    ...
    function o(e, n, a) {
        ...
        function s(e) {
            ...
            u += "<" + r(e) + N.map.call(e.attributes, n).join("") + ">"
        }
        ...
        function n(a, i) {
            if (!a.compiled) {
                if (a.compiled = !0, a.k = a.k || a.bK, a.k) {
                    ...
                    "string" == typeof a.k ? o("keyword", a.k) : w(a.k).forEach(function (e) {
                        o(e, a.k[e])
                    }), a.k = c
                }
    ...
    function u(e, r, a, i) {
        function s(e, t) {
            var r, a;
            for (r = 0, a = t.c.length; a > r; r++)if (n(t.c[r].bR, e))return t.c[r]
        }
        ...
        function p(e, t, r, n) {
            var a = n ? "" : B.classPrefix, i = '<span class="' + a, s = r ? "" : A;
            return i += e + '">', i + t + s
        }
        ...
        function m() {
            var e, r, n, a;
            if (!w.k)return t(E);
            for (a = "", r = 0, w.lR.lastIndex = 0, n = w.lR.exec(E); n;)a += t(E.substr(r, n.index - r)), e = b(w, n), e ? (M += e[1], a += p(e[0], t(n[0]))) : a += t(n[0]), r = w.lR.lastIndex, n = w.lR.exec(E);
            return a + t(E.substr(r))
        }

        function f() {
            var e = "string" == typeof w.sL;
            if (e && !k[w.sL])return t(E);
            var r = e ? u(w.sL, E, !0, x[w.sL]) : d(E, w.sL.length ? w.sL : void 0);
            return w.r > 0 && (M += r.r), e && (x[w.sL] = r.top), p(r.language, r.value, !1, !0)
        }
        ...
        function _(e) {
            C += e.cN ? p(e.cN, "", !0) : "", w = Object.create(e, {parent: {value: w}})
        }
        ...
        function h(e, t) {
            ...
            if (n) {
                var a = w;
                a.skip ? E += t : (a.rE || a.eE || (E += t), g(), a.eE && (E = t));
                do w.cN && (C += A), w.skip || (M += w.r), w = w.parent; while (w !== n.parent);
                return n.starts && _(n.starts, ""), a.rE ? 0 : t.length
            }
            if (o(t, w))throw new Error('Illegal lexeme "' + t + '" for mode "' + (w.cN || "<unnamed>") + '"');
        ...
        l(v);
        var N, w = i || v, x = {}, C = "";
        for (N = w; N !== v; N = N.parent)N.cN && (C = p(N.cN, "", !0) + C);
        var E = "", M = 0;
        try {
            for (var S, L, z = 0; w.t.lastIndex = z, S = w.t.exec(r), S;)L = h(r.substr(z, S.index - z), S[0]), z = S.index + L;
            for (h(r.substr(z)), N = w; N.parent; N = N.parent)N.cN && (C += A);
            return {r: M, value: C, language: e, top: w}
        } catch (e) {
    ...
    function b(e) {
        return B.tabReplace || B.useBR ? e.replace(M, function (e, t) {
            return B.useBR && "\n" === e ? "<br>" : B.tabReplace ? t.replace(/\t/g, B.tabReplace) : void 0
        }) : e
    }

    function p(e, t, r) {
        var n = t ? x[t] : r, a = [e.trim()];
        return e.match(/\bhljs\b/) || a.push("hljs"), -1 === e.indexOf(n) && a.push(n), a.join(" ").trim()
    }

    function m(e) {
        var t, r, n, s, l, m = i(e);
        a(m) || (B.useBR ? (t = document.createElementNS("http://www.w3.org/1999/xhtml", "div"), t.innerHTML = e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n")) : t = e, l = t.textContent, n = m ? u(m, l, !0) : d(l), r = c(t), r.length && (s = document.createElementNS("http://www.w3.org/1999/xhtml", "div"), s.innerHTML = n.value, n.value = o(r, c(s), l)), n.value = b(n.value), e.innerHTML = n.value, e.className = p(e.className, m, n.language), e.result = {
            language: n.language,
            re: n.r
    ...
    var N = [], w = Object.keys, k = {}, x = {}, C = /^(no-?highlight|plain|text)$/i, E = /\blang(?:uage)?-([\w-]+)\b/i,
        M = /((^(<[^>]+>|\t|)+|(?:\n)))/gm, A = "</span>",
    ...
    return e.highlight = u, e.highlightAuto = d, e.fixMarkup = b, e.highlightBlock = m, e.configure = f, e.initHighlighting = g, e.initHighlightingOnLoad = _, e.registerLanguage = h, e.listLanguages = v, e.getLanguage = y, e.inherit = s, e.IR = "[a-zA-Z]\\w*", e.UIR = "[a-zA-Z_]\\w*", e.NR = "\\b\\d+(\\.\\d+)?", e.CNR = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", e.BNR = "\\b(0b[01]+)", e.RSR = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", e.BE = {
        ...
        i: "\\n",
        c: [e.BE]
    }, e.PWM = {b: /\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|like)\b/}, e.C = function (t, r, n) {
    ...
    var t = {
        ...
        }, r = {cN: "type", b: "\\b[A-Z][\\w']*", r: 0}, n = e.C("/\\*", "\\*/", {c: ["self"]}),
        a = {cN: "subst", b: /\\\(/, e: "\\)", k: t, c: []}, i = {
            cN: "number",
            b: "\\b([\\d_]+(\\.[\\deE_]+)?|0x[a-fA-F0-9_]+(\\.[a-fA-F0-9p_]+)?|0b[01_]+|0o[0-7_]+)\\b",
            r: 0
        }, s = e.inherit(e.QSM, {c: [a, e.BE]});
    return a.c = [i], {
        k: t,
        c: [s, e.CLCM, n, r, i, {
            cN: "function",
    ...
    var t = "getpwent getservent quotemeta msgrcv scalar kill dbmclose undef lc ma syswrite tr send umask sysopen shmwrite vec qx utime local oct semctl localtime readpipe do return format read sprintf dbmopen pop getpgrp not getpwnam rewinddir qqfileno qw endprotoent wait sethostent bless s|0 opendir continue each sleep endgrent shutdown dump chomp connect getsockname die socketpair close flock exists index shmgetsub for endpwent redo lstat msgctl setpgrp abs exit select print ref gethostbyaddr unshift fcntl syscall goto getnetbyaddr join gmtime symlink semget splice x|0 getpeername recv log setsockopt cos last reverse gethostbyname getgrnam study formline endhostent times chop length gethostent getnetent pack getprotoent getservbyname rand mkdir pos chmod y|0 substr endnetent printf next open msgsnd readdir use unlink getsockopt getpriority rindex wantarray hex system getservbyport endservent int chr untie rmdir prototype tell listen fork shmread ucfirst setprotoent else sysseek link getgrgid shmctl waitpid unpack getnetbyname reset chdir grep split require caller lcfirst until warn while values shift telldir getpwuid my getprotobynumber delete and sort uc defined srand accept package seekdir getprotobyname semop our rename seek if q|0 chroot sysread setpwent no crypt getc chown sqrt write setnetent setpriority foreach tie sin msgget map stat getlogin unless elsif truncate exec keys glob tied closedirioctl socket readlink eval xor readline binmode setservent eof ord bind alarm pipe atan2 getgrent exp time push setgrent gt lt or ne m|0 break given say state when",
        r = {cN: "subst", b: "[$@]\\{", e: "\\}", k: t}, n = {b: "->{", e: "}"},
        a = {v: [{b: /\$\d/}, {b: /[\$%@](\^\w\b|#\w+(::\w+)*|{\w+}|\w+(::\w*)*)/}, {b: /[\$%@][^\s\w{]/, r: 0}]},
        i = [e.BE, r, a], s = [a, e.HCM, e.C("^\\=\\w", "\\=cut", {eW: !0}), n, {
            cN: "string",
            c: i,
    ...
    return r.c = s, n.c = s, {aliases: ["pl", "pm"], l: /[\w\.]+/, k: t, c: s}
    ...
    var t = {
        ...
        }, r = {cN: "string", b: '@"', e: '"', c: [{b: '""'}]}, n = e.inherit(r, {i: /\n/}),
        a = {cN: "subst", b: "{", e: "}", k: t}, i = e.inherit(a, {i: /\n/}),
        s = {cN: "string", b: /\$"/, e: '"', i: /\n/, c: [{b: "{{"}, {b: "}}"}, e.BE, i]},
        c = {cN: "string", b: /\$@"/, e: '"', c: [{b: "{{"}, {b: "}}"}, {b: '""'}, a]},
        o = e.inherit(c, {i: /\n/, c: [{b: "{{"}, {b: "}}"}, {b: '""'}, i]});
    a.c = [c, s, r, e.ASM, e.QSM, e.CNM, e.CBCM], i.c = [o, s, n, e.ASM, e.QSM, e.CNM, e.inherit(e.CBCM, {i: /\n/})];
    var l = {v: [c, s, r, e.ASM, e.QSM]}, u = e.IR + "(<" + e.IR + ">)?(\\[\\])?";
    return {
        aliases: ["csharp"],
        k: t,
        i: /::/,
    ...
    }, n = /[a-zA-Z@][a-zA-Z0-9_]*/, a = "@interface @class @protocol @implementation";
    return {
    ...
    var t = "\\[=*\\[", r = "\\]=*\\]", n = {b: t, e: r, c: ["self"]},
        a = [e.C("--(?!" + t + ")", "$"), e.C("--" + t, r, {c: [n], r: 10})];
    return {
        l: e.UIR,
        k: {
        ...
        }, e.CNM, e.ASM, e.QSM, {cN: "string", b: t, e: r, c: [n], r: 5}])
    }
    ...
    return {
        ...
        c: [e.HCM, e.C("//", "$", {c: [r]}), e.C("/\\*", "\\*/", {
            ...
            eE: !0,
            i: "\\$|\\[|%",
            c: [e.UTM, {cN: "params", b: "\\(", e: "\\)", c: ["self", t, e.CBCM, n, a]}]
        }, {
            cN: "class",
            bK: "class interface",
            e: "{",
            ...
            i: /[:\(\$"]/,
            c: [{bK: "extends implements"}, e.UTM]
        }, {bK: "namespace", e: ";", i: /[\.']/, c: [e.UTM]}, {bK: "use", e: ";", c: [e.UTM]}, {b: "=>"}, n, a]
    }
